...
[Previous](/docs/components/radix/tooltip)[Next](/docs)

Styles for headings, paragraphs, lists...etc

[Radix UI](/docs/components/radix/typography)[Base UI](/docs/components/base/typography)
...
[ Tooltip](/docs/components/radix/tooltip)[Introduction ](/docs)

On This Page

h1h2h3h4pblockquotetablelistInline codeLeadLargeSmallMutedRTL
