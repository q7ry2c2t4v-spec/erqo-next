...
[Previous](/docs/components/radix/dialog)[Next](/docs/components/radix/drawer)

A provider component that sets the text direction for your application.

[Radix UI](/docs/components/radix/direction)[Base UI](/docs/components/base/direction)
...
[ Dialog](/docs/components/radix/dialog)[Drawer ](/docs/components/radix/drawer)

On This Page

InstallationUsageuseDirection
