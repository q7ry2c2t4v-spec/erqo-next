...
> Source: https://threejs.org/docs/pages/EdgeSplitModifier.html
> Category: Addons
...
### .modify( geometry : [BufferGeometry](BufferGeometry.html), cutOffAngle : number, tryKeepNormals : boolean ) : [BufferGeometry](BufferGeometry.html)
...
---|---  
**cutOffAngle** |  The cut off angle in radians.  
**tryKeepNormals** |  Whether to try to keep normals or not. Default is `true`.  
