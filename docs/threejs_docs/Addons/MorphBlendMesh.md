...
> Source: https://threejs.org/docs/pages/MorphBlendMesh.html
> Category: Addons
...
### new MorphBlendMesh( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)> )
