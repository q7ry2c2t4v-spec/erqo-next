...
> Source: https://threejs.org/docs/pages/UnrealBloomPass.html
> Category: Addons
...
### new UnrealBloomPass( resolution : [Vector2](Vector2.html), strength : number, radius : number, threshold : number )
...
**radius** |  The Bloom radius.  
**threshold** |  The luminance threshold limits which bright areas contribute to the Bloom effect.  
  
## Properties

### .clearColor : [Color](Color.html)
