...
> Source: https://threejs.org/docs/pages/AnimationClipCreator.html
> Category: Addons
...
### .CreateMaterialColorAnimation( duration : number, colors : Array.<[Color](Color.html)> ) : [AnimationClip](AnimationClip.html)
...
### .CreatePulsationAnimation( duration : number, pulseScale : number ) : [AnimationClip](AnimationClip.html)
...
### .CreateRotationAnimation( period : number, axis : 'x' | 'y' | 'z' ) : [AnimationClip](AnimationClip.html)
...
### .CreateScaleAxisAnimation( period : number, axis : 'x' | 'y' | 'z' ) : [AnimationClip](AnimationClip.html)
...
### .CreateShakeAnimation( duration : number, shakeScale : [Vector3](Vector3.html) ) : [AnimationClip](AnimationClip.html)
...
### .CreateVisibilityAnimation( duration : number ) : [AnimationClip](AnimationClip.html)
