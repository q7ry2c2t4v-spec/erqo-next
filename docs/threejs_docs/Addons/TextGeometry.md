...
> Source: https://threejs.org/docs/pages/TextGeometry.html
> Category: Addons

[EventDispatcher](EventDispatcher.html) → [BufferGeometry](BufferGeometry.html) → [ExtrudeGeometry](ExtrudeGeometry.html) → 
...
### new TextGeometry( text : string, parameters : [TextGeometry~Options](TextGeometry.html#~Options) )
