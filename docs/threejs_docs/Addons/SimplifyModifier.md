...
> Source: https://threejs.org/docs/pages/SimplifyModifier.html
> Category: Addons
...
### .modify( geometry : [BufferGeometry](BufferGeometry.html), count : number ) : [BufferGeometry](BufferGeometry.html)
...
---|---  
**count** |  The number of vertices to remove.  
