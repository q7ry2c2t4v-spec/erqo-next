...
> Source: https://threejs.org/docs/pages/SelectionHelper.html
> Category: Addons
...
### new SelectionHelper( renderer : [WebGPURenderer](WebGPURenderer.html) | [WebGLRenderer](WebGLRenderer.html), cssClassName : string )
...
### .renderer : [WebGPURenderer](WebGPURenderer.html) | [WebGLRenderer](WebGLRenderer.html)
