...
> Source: https://threejs.org/docs/pages/Wireframe.html
> Category: Addons
...
### new Wireframe( geometry : [LineSegmentsGeometry](LineSegmentsGeometry.html), material : [LineMaterial](LineMaterial.html) )
...
### .computeLineDistances() : [Wireframe](Wireframe.html)
