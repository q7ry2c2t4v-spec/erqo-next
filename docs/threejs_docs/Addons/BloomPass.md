...
> Source: https://threejs.org/docs/pages/BloomPass.html
> Category: Addons
...
### .materialCombine : [ShaderMaterial](ShaderMaterial.html)

The combine pass material.

### .materialConvolution : [ShaderMaterial](ShaderMaterial.html)
