...
> Source: https://threejs.org/docs/pages/PLYExporter.html
> Category: Addons
...
### .parse( object : [Object3D](Object3D.html), onDone : [PLYExporter~OnDone](PLYExporter.html#~OnDone), options : [PLYExporter~Options](PLYExporter.html#~Options) ) : string | ArrayBuffer
