...
> Source: https://threejs.org/docs/pages/VRButton.html
> Category: Addons
...
### .createButton( renderer : [WebGLRenderer](WebGLRenderer.html) | [WebGPURenderer](WebGPURenderer.html), sessionInit : XRSessionInit ) : HTMLElement
