...
> Source: https://threejs.org/docs/pages/CSM.html
> Category: Addons
...
### new CSM( data : [CSM~Data](CSM.html#~Data) )
...
### .frustums : Array.<[CSMFrustum](CSMFrustum.html)>

An array of frustums representing the cascades.

### .lightDirection : [Vector3](Vector3.html)
...
### .lights : Array.<[DirectionalLight](DirectionalLight.html)>
...
### .shaders : Map.<[Material](Material.html), Object>
...
### .setupMaterial( material : [Material](Material.html) )
...
**camera**   
[Camera](Camera.html) |  The scene's camera.  
---|---  
**parent**   
[Object3D](Object3D.html) |  The parent object, usually the scene.  
**cascades**   
...
**lightDirection**   
[Vector3](Vector3.html) |  The light direction.  
**lightIntensity**   
