...
> Source: https://threejs.org/docs/pages/RectAreaLightTexturesLib.html
> Category: Addons
...
### .LTC_FLOAT_1 : [DataTexture](DataTexture.html)

The first LTC FP32 data texture.

Default is `null`.

### .LTC_FLOAT_2 : [DataTexture](DataTexture.html)

The second LTC FP32 data texture.

Default is `null`.

### .LTC_HALF_1 : [DataTexture](DataTexture.html)

The first LTC FP16 data texture.

Default is `null`.

### .LTC_HALF_2 : [DataTexture](DataTexture.html)
...
### .init() : [RectAreaLightTexturesLib](RectAreaLightTexturesLib.html)
