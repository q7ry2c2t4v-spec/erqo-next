...
> Source: https://threejs.org/docs/pages/BloomNode.html
> Category: Addons
...
### new BloomNode( inputNode : [Node](Node.html).<vec4>, strength : number, radius : number, threshold : number )
...
### .smoothWidth : [UniformNode](UniformNode.html).<float>

Can be used to tweak the extracted luminance from the scene.

### .strength : [UniformNode](UniformNode.html).<float>

The strength of the bloom.

### .threshold : [UniformNode](UniformNode.html).<float>
