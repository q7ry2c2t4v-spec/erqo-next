...
> Source: https://threejs.org/docs/pages/ArcballControls.html
> Category: Addons
...
### new ArcballControls( camera : [Camera](Camera.html), domElement : HTMLElement, scene : [Scene](Scene.html) )
...
### .setCamera( camera : [Camera](Camera.html) )
