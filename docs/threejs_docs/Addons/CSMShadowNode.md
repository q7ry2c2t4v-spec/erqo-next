...
> Source: https://threejs.org/docs/pages/CSMShadowNode.html
> Category: Addons
...
### new CSMShadowNode( light : [DirectionalLight](DirectionalLight.html), data : [CSMShadowNode~Data](CSMShadowNode.html#~Data) )
