...
> Source: https://threejs.org/docs/pages/CCDIKSolver.html
> Category: Addons
...
### new CCDIKSolver( mesh : [SkinnedMesh](SkinnedMesh.html), iks : Array.<[CCDIKSolver~IK](CCDIKSolver.html#~IK)> )
...
### .mesh : [SkinnedMesh](SkinnedMesh.html)

The skinned mesh.

## Methods

### .createHelper( sphereSize : number ) : [CCDIKHelper](CCDIKHelper.html)
...
### .update( globalBlendFactor : number ) : [CCDIKSolver](CCDIKSolver.html)
...
### .updateOne( ik : [CCDIKSolver~IK](CCDIKSolver.html#~IK), overrideBlend : number ) : [CCDIKSolver](CCDIKSolver.html)
...
**links**   
Array.<[CCDIKSolver~BoneLink](CCDIKSolver.html#~BoneLink)> |  An array of bone links.  
**iteration**   
