...
> Source: https://threejs.org/docs/pages/SSRNode.html
> Category: Addons
...
### new SSRNode( colorNode : [Node](Node.html).<vec4>, depthNode : [Node](Node.html).<float>, normalNode : [Node](Node.html).<vec3>, metalnessNode : [Node](Node.html).<float>, roughnessNode : [Node](Node.html).<float>, camera : [Camera](Camera.html) )
...
### .blurQuality : [UniformNode](UniformNode.html).<int>
...
### .maxDistance : [UniformNode](UniformNode.html).<float>
...
### .metalnessNode : [Node](Node.html).<float>
...
### .opacity : [UniformNode](UniformNode.html).<float>

Controls how the SSR reflections are blended with the beauty pass.

### .quality : [UniformNode](UniformNode.html).<float>
