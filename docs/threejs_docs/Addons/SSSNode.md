...
> Source: https://threejs.org/docs/pages/SSSNode.html
> Category: Addons
...
### new SSSNode( depthNode : [TextureNode](TextureNode.html), camera : [Camera](Camera.html), mainLight : [DirectionalLight](DirectionalLight.html) )
...
### .shadowIntensity : [UniformNode](UniformNode.html).<float>
