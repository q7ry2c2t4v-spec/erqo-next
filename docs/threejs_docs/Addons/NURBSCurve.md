...
> Source: https://threejs.org/docs/pages/NURBSCurve.html
> Category: Addons
...
### new NURBSCurve( degree : number, knots : Array.<number>, controlPoints : Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html)|[Vector4](Vector4.html))>, startKnot : number, endKnot : number )
...
### .controlPoints : Array.<[Vector4](Vector4.html)>
...
### .getTangent( t : number, optionalTarget : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
