...
> Source: https://threejs.org/docs/pages/XRControllerModelFactory.html
> Category: Addons
...
### new XRControllerModelFactory( gltfLoader : [GLTFLoader](GLTFLoader.html), onLoad : function )

Constructs a new XR controller model factory.

**gltfLoader** |  A glTF loader that is used to load controller models. Default is `null`.  
---|---  
...
### .createControllerModel( controller : [Group](Group.html) ) : [XRControllerModel](XRControllerModel.html)
...
### .setPath( path : string ) : [XRControllerModelFactory](XRControllerModelFactory.html)
