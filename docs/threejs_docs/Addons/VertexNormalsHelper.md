...
> Source: https://threejs.org/docs/pages/VertexNormalsHelper.html
> Category: Addons
...
### new VertexNormalsHelper( object : [Object3D](Object3D.html), size : number, color : number | [Color](Color.html) | string )
