...
> Source: https://threejs.org/docs/pages/SSAARenderPass.html
> Category: Addons
...
### new SSAARenderPass( scene : [Scene](Scene.html), camera : [Camera](Camera.html), clearColor : number | [Color](Color.html) | string, clearAlpha : number )
