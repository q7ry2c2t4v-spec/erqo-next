...
> Source: https://threejs.org/docs/pages/OculusHandPointerModel.html
> Category: Addons
...
### new OculusHandPointerModel( hand : [Group](Group.html), controller : [Group](Group.html) )
...
### .cursorObject : [Mesh](Mesh.html)

The cursor object.

Default is `null`.

### .hand : [Group](Group.html)
...
### .pointerGeometry : [BufferGeometry](BufferGeometry.html)

The pointer geometry.

Default is `null`.

### .pointerMesh : [Mesh](Mesh.html)

The pointer mesh.

Default is `null`.

### .pointerObject : [Object3D](Object3D.html)
...
### .checkIntersections( objects : Array.<[Object3D](Object3D.html)>, recursive : boolean )
...
### .intersectObject( object : [Object3D](Object3D.html), recursive : boolean ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)>
...
### .intersectObjects( objects : Array.<[Object3D](Object3D.html)>, recursive : boolean ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)>
