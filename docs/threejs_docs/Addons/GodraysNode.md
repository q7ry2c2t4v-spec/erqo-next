...
> Source: https://threejs.org/docs/pages/GodraysNode.html
> Category: Addons
...
### new GodraysNode( depthNode : [TextureNode](TextureNode.html), camera : [Camera](Camera.html), light : [DirectionalLight](DirectionalLight.html) | [PointLight](PointLight.html) )
...
**light** |  The light the godrays are rendered for.  
  
## Properties

### .density : [UniformNode](UniformNode.html).<float>
