...
> Source: https://threejs.org/docs/pages/Octree.html
> Category: Addons
...
### new Octree( box : [Box3](Box3.html) )

Constructs a new Octree.

**box** |  The base box with enclose the entire Octree.  
---|---  
  
## Properties

### .bounds : [Box3](Box3.html)
...
### .addTriangle( triangle : [Triangle](Triangle.html) ) : [Octree](Octree.html)
...
### .boxIntersect( box : [Box3](Box3.html) ) : Object | boolean
...
### .build() : [Octree](Octree.html)

Builds the Octree.

**Returns:** A reference to this Octree.

### .calcBox() : [Octree](Octree.html)

Prepares [Octree#box](Octree.html#box) for the build.

**Returns:** A reference to this Octree.

### .capsuleIntersect( capsule : [Capsule](Capsule.html) ) : Object | boolean
...
### .clear() : [Octree](Octree.html)

Clears the Octree by making it empty.

**Returns:** A reference to this Octree.

### .fromGraphNode( group : [Object3D](Object3D.html) ) : [Octree](Octree.html)

Constructs the Octree from the given 3D object.

**group** |  The scene graph node.  
---|---  
  
**Returns:** A reference to this Octree.

### .getBoxTriangles( box : [Box3](Box3.html), triangles : Array.<[Triangle](Triangle.html)> )

Computes the triangles that potentially intersect with the given bounding box.

**box** |  The bounding box.  
---|---  
**triangles** |  The target array that holds the triangles.  
  
### .getCapsuleTriangles( capsule : [Capsule](Capsule.html), triangles : Array.<[Triangle](Triangle.html)> )
...
### .getRayTriangles( ray : [Ray](Ray.html), triangles : Array.<[Triangle](Triangle.html)> )
...
### .getSphereTriangles( sphere : [Sphere](Sphere.html), triangles : Array.<[Triangle](Triangle.html)> )
...
### .rayIntersect( ray : [Ray](Ray.html) ) : Object | boolean
...
### .sphereIntersect( sphere : [Sphere](Sphere.html) ) : Object | boolean
...
### .split( level : number ) : [Octree](Octree.html)
...
### .triangleBoxIntersect( box : [Box3](Box3.html), triangle : [Triangle](Triangle.html) ) : Object | false
...
### .triangleCapsuleIntersect( capsule : [Capsule](Capsule.html), triangle : [Triangle](Triangle.html) ) : Object | false
...
### .triangleSphereIntersect( sphere : [Sphere](Sphere.html), triangle : [Triangle](Triangle.html) ) : Object | false
