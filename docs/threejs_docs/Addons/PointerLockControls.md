...
> Source: https://threejs.org/docs/pages/PointerLockControls.html
> Category: Addons
...
### new PointerLockControls( camera : [Camera](Camera.html), domElement : HTMLElement )
...
### .getDirection( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
