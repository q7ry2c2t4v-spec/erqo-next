...
> Source: https://threejs.org/docs/pages/OrbitControls.html
> Category: Addons
...
### new OrbitControls( object : [Object3D](Object3D.html), domElement : HTMLElement )
...
### .position0 : [Vector3](Vector3.html)
...
**dollyScale** |  The dolly scale factor.  
---|---  
...
**deltaX** |  The horizontal pan amount in pixels.  
---|---  
**deltaY** |  The vertical pan amount in pixels.  
