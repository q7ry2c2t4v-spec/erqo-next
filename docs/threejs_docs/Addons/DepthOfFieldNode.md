...
> Source: https://threejs.org/docs/pages/DepthOfFieldNode.html
> Category: Addons
...
### new DepthOfFieldNode( textureNode : [TextureNode](TextureNode.html), viewZNode : [Node](Node.html).<float>, focusDistanceNode : [Node](Node.html).<float>, focalLengthNode : [Node](Node.html).<float>, bokehScaleNode : [Node](Node.html).<float> )
...
### .viewZNode : [Node](Node.html).<float>
