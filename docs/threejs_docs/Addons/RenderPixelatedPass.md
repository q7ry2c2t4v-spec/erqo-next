...
> Source: https://threejs.org/docs/pages/RenderPixelatedPass.html
> Category: Addons
...
### new RenderPixelatedPass( pixelSize : number, scene : [Scene](Scene.html), camera : [Camera](Camera.html), options : Object )
...
### .pixelatedMaterial : [ShaderMaterial](ShaderMaterial.html)
