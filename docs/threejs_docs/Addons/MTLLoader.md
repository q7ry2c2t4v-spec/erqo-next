...
> Source: https://threejs.org/docs/pages/MTLLoader.html
> Category: Addons
...
### .setMaterialOptions( value : [MTLLoader~MaterialOptions](MTLLoader.html#~MaterialOptions) ) : [MTLLoader](MTLLoader.html)
...
**side**   
[FrontSide](global.html#FrontSide) | [BackSide](global.html#BackSide) | [DoubleSide](global.html#DoubleSide) |  Which side to apply the material. Default is `FrontSide`.  
---|---  
**wrap**   
[RepeatWrapping](global.html#RepeatWrapping) | [ClampToEdgeWrapping](global.html#ClampToEdgeWrapping) | [MirroredRepeatWrapping](global.html#MirroredRepeatWrapping) |  What type of wrapping to apply for textures. Default is `RepeatWrapping`.  
**normalizeRGB**   
