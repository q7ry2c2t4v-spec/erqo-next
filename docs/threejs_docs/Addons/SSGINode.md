...
> Source: https://threejs.org/docs/pages/SSGINode.html
> Category: Addons
...
References:
  ...
  * <https://cdrinmatane.github.io/cgspotlight-slides/ssilvb_slides.pdf>.
...
### new SSGINode( beautyNode : [TextureNode](TextureNode.html), depthNode : [TextureNode](TextureNode.html), normalNode : [TextureNode](TextureNode.html), camera : [PerspectiveCamera](PerspectiveCamera.html) )
...
### .expFactor : [UniformNode](UniformNode.html).<float>
...
### .giIntensity : [UniformNode](UniformNode.html).<float>
...
### .sliceCount : [UniformNode](UniformNode.html).<uint>
...
### .stepCount : [UniformNode](UniformNode.html).<uint>
...
### .useLinearThickness : [UniformNode](UniformNode.html).<bool>

Whether to increase thickness linearly over distance or not (avoid losing detail over the distance).

Default is `false`.

### .useScreenSpaceSampling : [UniformNode](UniformNode.html).<bool>
