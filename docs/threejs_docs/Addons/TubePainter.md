...
> Source: https://threejs.org/docs/pages/TubePainter.html
> Category: Addons
...
### .lineTo( position : [Vector3](Vector3.html) )
...
### .moveTo( position : [Vector3](Vector3.html) )
...
### .setColor( color : [Color](Color.html) )
