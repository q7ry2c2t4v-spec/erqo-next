...
### new DRACOLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( buffer : ArrayBuffer, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )

Parses the given Draco data.

**buffer** |  The raw Draco data as an array buffer.  
---|---  
...
### .setDecoderConfig( config : Object ) : [DRACOLoader](DRACOLoader.html)
...
### .setDecoderPath( path : string ) : [DRACOLoader](DRACOLoader.html)

Provides configuration for the decoder libraries. Configuration cannot be changed after decoding begins.

**path** |  The decoder path.  
---|---  
  
**Returns:** A reference to this loader.

### .setWorkerLimit( workerLimit : number ) : [DRACOLoader](DRACOLoader.html)
