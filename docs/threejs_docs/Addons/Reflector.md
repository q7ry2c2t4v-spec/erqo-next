...
> Source: https://threejs.org/docs/pages/Reflector.html
> Category: Addons
...
### new Reflector( geometry : [BufferGeometry](BufferGeometry.html), options : [Reflector~Options](Reflector.html#~Options) )
