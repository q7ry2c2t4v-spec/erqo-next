...
> Source: https://threejs.org/docs/pages/Lut.html
> Category: Addons
...
### .addColorMap( name : string, arrayOfColors : Array.<Array.<number>> ) : [Lut](Lut.html)
...
### .copy( lut : [Lut](Lut.html) ) : [Lut](Lut.html)
...
### .getColor( alpha : number ) : [Color](Color.html)
...
### .set( value : [Lut](Lut.html) ) : [Lut](Lut.html)
...
### .setColorMap( colormap : string, count : number ) : [Lut](Lut.html)
...
### .setMax( max : number ) : [Lut](Lut.html)
...
### .setMin( min : number ) : [Lut](Lut.html)
