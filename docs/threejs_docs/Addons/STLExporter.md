...
> Source: https://threejs.org/docs/pages/STLExporter.html
> Category: Addons
...
### .parse( scene : [Object3D](Object3D.html), options : [STLExporter~Options](STLExporter.html#~Options) ) : string | ArrayBuffer

Parses the given 3D object and generates the STL output.

If the 3D object is composed of multiple children and geometry, they are merged into a single mesh in the file.

**scene** |  A scene, mesh or any other 3D object containing meshes to encode.  
---|---  
