...
> Source: https://threejs.org/docs/pages/AfterimagePass.html
> Category: Addons
...
### .compFsMaterial : [ShaderMaterial](ShaderMaterial.html)

The composition material.

### .copyFsMaterial : [ShaderMaterial](ShaderMaterial.html)
