...
> Source: https://threejs.org/docs/pages/UltraHDRLoader.html
> Category: Addons
...
### new UltraHDRLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .setDataType( value : [HalfFloatType](global.html#HalfFloatType) | [FloatType](global.html#FloatType) ) : [UltraHDRLoader](UltraHDRLoader.html)
