...
> Source: https://threejs.org/docs/pages/USDLoader.html
> Category: Addons
...
### new USDLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( buffer : ArrayBuffer | string ) : [Group](Group.html)
