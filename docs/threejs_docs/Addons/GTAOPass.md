...
> Source: https://threejs.org/docs/pages/GTAOPass.html
> Category: Addons
...
### new GTAOPass( scene : [Scene](Scene.html), camera : [Camera](Camera.html), width : number, height : number, parameters : Object, aoParameters : Object, pdParameters : Object )
...
### .gtaoMap : [Texture](Texture.html) (readonly) 
...
### .setGBuffer( depthTexture : [DepthTexture](DepthTexture.html), normalTexture : [DepthTexture](DepthTexture.html) )
...
### .setSceneClipBox( box : [Box3](Box3.html) )
