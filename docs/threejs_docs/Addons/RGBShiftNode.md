...
> Source: https://threejs.org/docs/pages/RGBShiftNode.html
> Category: Addons
...
### new RGBShiftNode( textureNode : [TextureNode](TextureNode.html), amount : number, angle : number )
...
### .amount : [UniformNode](UniformNode.html).<float>
