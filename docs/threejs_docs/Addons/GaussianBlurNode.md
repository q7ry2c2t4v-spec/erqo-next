...
> Source: https://threejs.org/docs/pages/GaussianBlurNode.html
> Category: Addons
...
### new GaussianBlurNode( textureNode : [TextureNode](TextureNode.html), directionNode : [Node](Node.html).<(vec2|float)>, sigma : number, options : Object )
