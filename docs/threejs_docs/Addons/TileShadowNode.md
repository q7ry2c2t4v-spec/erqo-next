...
> Source: https://threejs.org/docs/pages/TileShadowNode.html
> Category: Addons
...
### new TileShadowNode( light : [Light](Light.html), options : Object )
...
### .setup( builder : Builder ) : [Node](Node.html)
...
### .syncLightTransformation( lwLight : LwLight, sourceLight : [Light](Light.html) )
