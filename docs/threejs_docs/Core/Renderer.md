...
> Source: https://threejs.org/docs/pages/Renderer.html
> Category: Core
...
### new Renderer( backend : [Backend](Backend.html), parameters : [Renderer~Options](Renderer.html#~Options) )
...
### .contextNode : [ContextNode](ContextNode.html)
...
**value**   
Object |  The context value object.  
---|---  
...
### .debug : [DebugConfig](global.html#DebugConfig)
...
### .inspector : [InspectorBase](InspectorBase.html)
...
### .library : [NodeLibrary](NodeLibrary.html)
...
### .shadowMap : [ShadowMapConfig](global.html#ShadowMapConfig)
...
### .compile( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html), targetScene : [Scene](Scene.html) ) : function
...
### .compute( computeNodes : [Node](Node.html) | Array.<[Node](Node.html)>, dispatchSize : number | Array.<number> | [IndirectStorageBufferAttribute](IndirectStorageBufferAttribute.html) ) : Promise | undefined
...
### .computeAsync( computeNodes : [Node](Node.html) | Array.<[Node](Node.html)>, dispatchSize : number | Array.<number> | [IndirectStorageBufferAttribute](IndirectStorageBufferAttribute.html) ) : Promise (async) 
...
### .copyFramebufferToTexture( framebufferTexture : [FramebufferTexture](FramebufferTexture.html), rectangle : [Vector2](Vector2.html) | [Vector4](Vector4.html) )
...
### .getArrayBufferAsync( attribute : [StorageBufferAttribute](StorageBufferAttribute.html) ) : Promise.<ArrayBuffer> (async) 
...
### .getCanvasTarget() : [CanvasTarget](CanvasTarget.html)
...
### .getOutputRenderTarget() : [RenderTarget](RenderTarget.html)
...
### .getRenderTarget() : [RenderTarget](RenderTarget.html)
...
### .initRenderTarget( renderTarget : [RenderTarget](RenderTarget.html) )

Initializes the given render target.

**renderTarget** |  The render target to intialize.  
---|---  
...
### .initTextureAsync( texture : [Texture](Texture.html) ) : Promise (async) 
...
### .isOccluded( object : [Object3D](Object3D.html) ) : boolean
...
### .readRenderTargetPixelsAsync( renderTarget : [RenderTarget](RenderTarget.html), x : number, y : number, width : number, height : number, textureIndex : number, faceIndex : number ) : Promise.<TypedArray> (async) 
...
### .renderAsync( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html) ) : Promise (async) 
...
### .renderObject( object : [Object3D](Object3D.html), scene : [Scene](Scene.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object, lightsNode : [LightsNode](LightsNode.html), clippingContext : [ClippingContext](ClippingContext.html), passId : string )
...
### .setAnimationLoop( callback : [onAnimationCallback](global.html#onAnimationCallback) ) : Promise (async) 
...
### .setCanvasTarget( canvasTarget : [CanvasTarget](CanvasTarget.html) )
...
### .setMRT( mrt : [MRTNode](MRTNode.html) ) : [Renderer](Renderer.html)
...
### .setRenderObjectFunction( renderObjectFunction : [renderObjectFunction](global.html#renderObjectFunction) )
...
### .setRenderTarget( renderTarget : [RenderTarget](RenderTarget.html), activeCubeFace : number, activeMipmapLevel : number )
...
**x** |  The horizontal coordinate for the upper left corner of the box in logical pixel unit. Instead of passing four arguments, the method also works with a single four-dimensional vector.  
---|---  
**y** |  The vertical coordinate for the upper left corner of the box in logical pixel unit.  
...
### .setViewport( x : number | [Vector4](Vector4.html), y : number, width : number, height : number, minDepth : number, maxDepth : number )

Defines the viewport.

**x** |  The horizontal coordinate for the upper left corner of the viewport origin in logical pixel unit.  
---|---  
**y** |  The vertical coordinate for the upper left corner of the viewport origin in logical pixel unit.  
...
---|---  
**reversedDepthBuffer**   
boolean |  Whether reversed depth buffer is enabled or not. Default is `false`.  
**alpha**   
...
**outputBufferType**   
number |  Defines the type of output buffers. The default `HalfFloatType` is recommend for best quality. To save memory and bandwidth, `UnsignedByteType` might be used. This will reduce rendering quality though. Default is `HalfFloatType`.  
**multiview**   
