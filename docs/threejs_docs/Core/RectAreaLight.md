...
> Source: https://threejs.org/docs/pages/RectAreaLight.html
> Category: Core
...
### new RectAreaLight( color : number | [Color](Color.html) | string, intensity : number, width : number, height : number )
...
**width** |  The width of the light. Default is `10`.  
**height** |  The height of the light. Default is `10`.  
