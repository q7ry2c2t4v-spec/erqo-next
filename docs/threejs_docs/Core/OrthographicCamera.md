...
> Source: https://threejs.org/docs/pages/OrthographicCamera.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Object3D](Object3D.html) → [Camera](Camera.html) → 
...
**left** |  The left plane of the camera's frustum. Default is `-1`.  
---|---  
**right** |  The right plane of the camera's frustum. Default is `1`.  
**top** |  The top plane of the camera's frustum. Default is `1`.  
**bottom** |  The bottom plane of the camera's frustum. Default is `-1`.  
