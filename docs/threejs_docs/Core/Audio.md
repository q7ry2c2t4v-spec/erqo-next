...
> Source: https://threejs.org/docs/pages/Audio.html
> Category: Core
...
### new Audio( listener : [AudioListener](AudioListener.html) )
...
### .listener : [AudioListener](AudioListener.html) (readonly) 
...
### .pause() : [Audio](Audio.html) | undefined
...
### .play( delay : number ) : [Audio](Audio.html) | undefined

Starts the playback of the audio.

Can only be used with compatible audio sources that allow playback control.

**delay** |  The delay, in seconds, at which the audio should start playing. Default is `0`.  
---|---  
  
**Returns:** A reference to this instance.

### .setBuffer( audioBuffer : AudioBuffer ) : [Audio](Audio.html)
...
### .setDetune( value : number ) : [Audio](Audio.html)

Defines the detuning of oscillation in cents.

**value** |  The detuning of oscillation in cents.  
---|---  
  
**Returns:** A reference to this instance.

### .setFilter( filter : AudioNode ) : [Audio](Audio.html)
...
### .setFilters( value : Array.<AudioNode> ) : [Audio](Audio.html)

Sets an array of filters and connects them with the audio source.

**value** |  A list of filters.  
---|---  
  
**Returns:** A reference to this instance.

### .setLoop( value : boolean ) : [Audio](Audio.html) | undefined

Sets the loop flag.

Can only be used with compatible audio sources that allow playback control.

**value** |  Whether the audio should loop or not.  
---|---  
  
**Returns:** A reference to this instance.

### .setLoopEnd( value : number ) : [Audio](Audio.html)

Sets the loop end value which defines where in the audio buffer the replay should stop, in seconds.

**value** |  The loop end value.  
---|---  
  
**Returns:** A reference to this instance.

### .setLoopStart( value : number ) : [Audio](Audio.html)

Sets the loop start value which defines where in the audio buffer the replay should start, in seconds.

**value** |  The loop start value.  
---|---  
  
**Returns:** A reference to this instance.

### .setMediaElementSource( mediaElement : HTMLMediaElement ) : [Audio](Audio.html)
...
**mediaElement** |  The media element.  
---|---  
  
**Returns:** A reference to this instance.

### .setMediaStreamSource( mediaStream : MediaStream ) : [Audio](Audio.html)
...
### .setNodeSource( audioNode : AudioNode ) : [Audio](Audio.html)
...
**audioNode** |  The audio node like an instance of `OscillatorNode`.  
---|---  
  
**Returns:** A reference to this instance.

### .setPlaybackRate( value : number ) : [Audio](Audio.html) | undefined

Sets the playback rate.

Can only be used with compatible audio sources that allow playback control.

**value** |  The playback rate to set.  
---|---  
  
**Returns:** A reference to this instance.

### .setVolume( value : number ) : [Audio](Audio.html)
...
### .stop( delay : number ) : [Audio](Audio.html) | undefined

Stops the playback of the audio.

Can only be used with compatible audio sources that allow playback control.

**delay** |  The delay, in seconds, at which the audio should stop playing. Default is `0`.  
---|---  
