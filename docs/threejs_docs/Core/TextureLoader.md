...
> Source: https://threejs.org/docs/pages/TextureLoader.html
> Category: Core
...
### new TextureLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [Texture](Texture.html)
