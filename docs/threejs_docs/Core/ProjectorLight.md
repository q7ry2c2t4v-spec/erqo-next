...
> Source: https://threejs.org/docs/pages/ProjectorLight.html
> Category: Core
...
### new ProjectorLight( color : number | [Color](Color.html) | string, intensity : number, distance : number, angle : number, penumbra : number, decay : number )
