...
> Source: https://threejs.org/docs/pages/Path.html
> Category: Core

[Curve](Curve.html) → [CurvePath](CurvePath.html) → 
...
### new Path( points : Array.<[Vector2](Vector2.html)> )
...
### .currentPoint : [Vector2](Vector2.html)

The current offset of the path. Any new curve added will start here.

## Methods

### .absarc( aX : number, aY : number, aRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean ) : [Path](Path.html)
...
### .absellipse( aX : number, aY : number, xRadius : number, yRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean, aRotation : number ) : [Path](Path.html)
...
### .arc( aX : number, aY : number, aRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean ) : [Path](Path.html)
...
### .bezierCurveTo( aCP1x : number, aCP1y : number, aCP2x : number, aCP2y : number, aX : number, aY : number ) : [Path](Path.html)
...
### .ellipse( aX : number, aY : number, xRadius : number, yRadius : number, aStartAngle : number, aEndAngle : number, aClockwise : boolean, aRotation : number ) : [Path](Path.html)
...
### .lineTo( x : number, y : number ) : [Path](Path.html)
...
### .moveTo( x : number, y : number ) : [Path](Path.html)
...
### .quadraticCurveTo( aCPx : number, aCPy : number, aX : number, aY : number ) : [Path](Path.html)
...
### .setFromPoints( points : Array.<[Vector2](Vector2.html)> ) : [Path](Path.html)
...
### .splineThru( pts : Array.<[Vector2](Vector2.html)> ) : [Path](Path.html)
