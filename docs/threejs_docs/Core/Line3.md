...
> Source: https://threejs.org/docs/pages/Line3.html
> Category: Core
...
### new Line3( start : [Vector3](Vector3.html), end : [Vector3](Vector3.html) )
...
### .applyMatrix4( matrix : [Matrix4](Matrix4.html) ) : [Line3](Line3.html)
...
### .clone() : [Line3](Line3.html)

Returns a new line segment with copied values from this instance.

**Returns:** A clone of this instance.

### .closestPointToPoint( point : [Vector3](Vector3.html), clampToLine : boolean, target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .closestPointToPointParameter( point : [Vector3](Vector3.html), clampToLine : boolean ) : number
...
### .copy( line : [Line3](Line3.html) ) : [Line3](Line3.html)
...
### .delta( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .distanceSqToLine3( line : [Line3](Line3.html), c1 : [Vector3](Vector3.html), c2 : [Vector3](Vector3.html) ) : number
...
### .equals( line : [Line3](Line3.html) ) : boolean
...
### .set( start : [Vector3](Vector3.html), end : [Vector3](Vector3.html) ) : [Line3](Line3.html)
