...
> Source: https://threejs.org/docs/pages/Uniform.html
> Category: Core
...
### new Uniform( value : [any](global.html#any) )
...
### .getValue() : [any](global.html#any)

Returns the uniform's value.

**Returns:** The value.

### .setValue( value : [any](global.html#any) )
