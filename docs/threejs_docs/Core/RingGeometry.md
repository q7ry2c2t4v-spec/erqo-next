...
> Source: https://threejs.org/docs/pages/RingGeometry.html
> Category: Core
...
**thetaLength** |  Central angle in radians. Default is `Math.PI*2`.  
...
### .fromJSON( data : Object ) : [RingGeometry](RingGeometry.html)
