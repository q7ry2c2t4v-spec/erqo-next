...
> Source: https://threejs.org/docs/pages/VaryingNode.html
> Category: Core
...
### new VaryingNode( node : [Node](Node.html), name : string )
...
### .setInterpolation( type : string, sampling : string ) : [VaryingNode](VaryingNode.html)
...
### .setupVarying( builder : [NodeBuilder](NodeBuilder.html) ) : [NodeVarying](NodeVarying.html)
