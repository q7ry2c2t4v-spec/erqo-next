...
> Source: https://threejs.org/docs/pages/TubeGeometry.html
> Category: Core
...
### new TubeGeometry( path : [Curve](Curve.html), tubularSegments : number, radius : number, radialSegments : number, closed : boolean )

Constructs a new tube geometry.

**path** |  A 3D curve defining the path of the tube. Default is `QuadraticBezierCurve3`.  
---|---  
...
**closed** |  Whether the tube is closed or not. Default is `false`.  
...
### .fromJSON( data : Object ) : [TubeGeometry](TubeGeometry.html)
