...
> Source: https://threejs.org/docs/pages/ClippingNode.html
> Category: Core
...
**scope** |  The node's scope. Similar to other nodes, the selected scope influences the behavior of the node and what type of code is generated. Default is `'default'`.  
---|---  
...
### .setupAlphaToCoverage( intersectionPlanes : Array.<[Vector4](Vector4.html)>, unionPlanes : Array.<[Vector4](Vector4.html)> ) : [Node](Node.html)

Setups alpha to coverage.

**intersectionPlanes** |  The intersection planes.  
---|---  
**unionPlanes** |  The union planes.  
  
**Returns:** The result node.

### .setupDefault( intersectionPlanes : Array.<[Vector4](Vector4.html)>, unionPlanes : Array.<[Vector4](Vector4.html)> ) : [Node](Node.html)
...
### .setupHardwareClipping( unionPlanes : Array.<[Vector4](Vector4.html)>, builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html)
