...
> Source: https://threejs.org/docs/pages/LightProbe.html
> Category: Core
...
### new LightProbe( sh : [SphericalHarmonics3](SphericalHarmonics3.html), intensity : number )
...
### .sh : [SphericalHarmonics3](SphericalHarmonics3.html)
