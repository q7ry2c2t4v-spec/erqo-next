...
> Source: https://threejs.org/docs/pages/QuadraticBezierCurve3.html
> Category: Core
...
### new QuadraticBezierCurve3( v0 : [Vector3](Vector3.html), v1 : [Vector3](Vector3.html), v2 : [Vector3](Vector3.html) )
