...
> Source: https://threejs.org/docs/pages/Vector3.html
> Category: Core
...
### .add( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .addScalar( s : number ) : [Vector3](Vector3.html)
...
### .addScaledVector( v : [Vector3](Vector3.html) | [Vector4](Vector4.html), s : number ) : [Vector3](Vector3.html)

Adds the given vector scaled by the given factor to this instance.

**v** |  The vector.  
---|---  
**s** |  The factor that scales `v`.  
  
**Returns:** A reference to this vector.

### .addVectors( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .angleTo( v : [Vector3](Vector3.html) ) : number
...
### .applyAxisAngle( axis : [Vector3](Vector3.html), angle : number ) : [Vector3](Vector3.html)

Applies a rotation specified by an axis and an angle to this vector.

**axis** |  A normalized vector representing the rotation axis.  
---|---  
**angle** |  The angle in radians.  
  
**Returns:** A reference to this vector.

### .applyEuler( euler : [Euler](Euler.html) ) : [Vector3](Vector3.html)
...
### .applyMatrix3( m : [Matrix3](Matrix3.html) ) : [Vector3](Vector3.html)
...
### .applyMatrix4( m : [Matrix4](Matrix4.html) ) : [Vector3](Vector3.html)
...
### .applyNormalMatrix( m : [Matrix3](Matrix3.html) ) : [Vector3](Vector3.html)
...
### .applyQuaternion( q : [Quaternion](Quaternion.html) ) : [Vector3](Vector3.html)
...
### .ceil() : [Vector3](Vector3.html)

The components of this vector are rounded up to the nearest integer value.

**Returns:** A reference to this vector.

### .clamp( min : [Vector3](Vector3.html), max : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .clampLength( min : number, max : number ) : [Vector3](Vector3.html)
...
**min** |  The minimum value the vector length will be clamped to.  
---|---  
**max** |  The maximum value the vector length will be clamped to.  
  
**Returns:** A reference to this vector.

### .clampScalar( minVal : number, maxVal : number ) : [Vector3](Vector3.html)
...
**minVal** |  The minimum value the components will be clamped to.  
---|---  
**maxVal** |  The maximum value the components will be clamped to.  
...
### .copy( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .cross( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .crossVectors( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .distanceTo( v : [Vector3](Vector3.html) ) : number
...
### .distanceToSquared( v : [Vector3](Vector3.html) ) : number
...
**v** |  The vector to compute the squared distance to.  
---|---  
  
**Returns:** The squared distance.

### .divide( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .divideScalar( scalar : number ) : [Vector3](Vector3.html)
...
### .dot( v : [Vector3](Vector3.html) ) : number
...
### .equals( v : [Vector3](Vector3.html) ) : boolean

Returns `true` if this vector is equal with the given one.

**v** |  The vector to test for equality.  
---|---  
  
**Returns:** Whether this vector is equal with the given one.

### .floor() : [Vector3](Vector3.html)

The components of this vector are rounded down to the nearest integer value.

**Returns:** A reference to this vector.

### .fromArray( array : Array.<number>, offset : number ) : [Vector3](Vector3.html)

Sets this vector's x value to be `array[ offset ]`, y value to be `array[ offset + 1 ]` and z value to be `array[ offset + 2 ]`.

**array** |  An array holding the vector component values.  
---|---  
**offset** |  The offset into the array. Default is `0`.  
  
**Returns:** A reference to this vector.

### .fromBufferAttribute( attribute : [BufferAttribute](BufferAttribute.html), index : number ) : [Vector3](Vector3.html)
...
**index** |  The component index. `0` equals to x, `1` equals to y, `2` equals to z.  
---|---  
...
### .lerp( v : [Vector3](Vector3.html), alpha : number ) : [Vector3](Vector3.html)
...
**v** |  The vector to interpolate towards.  
---|---  
**alpha** |  The interpolation factor, typically in the closed interval `[0, 1]`.  
  
**Returns:** A reference to this vector.

### .lerpVectors( v1 : [Vector3](Vector3.html), v2 : [Vector3](Vector3.html), alpha : number ) : [Vector3](Vector3.html)
...
### .manhattanDistanceTo( v : [Vector3](Vector3.html) ) : number

Computes the Manhattan distance from the given vector to this instance.

**v** |  The vector to compute the Manhattan distance to.  
---|---  
...
### .max( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .min( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .multiply( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .multiplyScalar( scalar : number ) : [Vector3](Vector3.html)
...
### .multiplyVectors( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .normalize() : [Vector3](Vector3.html)
...
### .project( camera : [Camera](Camera.html) ) : [Vector3](Vector3.html)
...
### .projectOnPlane( planeNormal : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .projectOnVector( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)

Projects this vector onto the given one.

**v** |  The vector to project to.  
---|---  
  
**Returns:** A reference to this vector.

### .random() : [Vector3](Vector3.html)

Sets each component of this vector to a pseudo-random value between `0` and `1`, excluding `1`.

**Returns:** A reference to this vector.

### .randomDirection() : [Vector3](Vector3.html)

Sets this vector to a uniformly random point on a unit sphere.

**Returns:** A reference to this vector.

### .reflect( normal : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .round() : [Vector3](Vector3.html)

The components of this vector are rounded to the nearest integer value

**Returns:** A reference to this vector.

### .roundToZero() : [Vector3](Vector3.html)

The components of this vector are rounded towards zero (up if negative, down if positive) to an integer value.

**Returns:** A reference to this vector.

### .set( x : number, y : number, z : number ) : [Vector3](Vector3.html)
...
### .setComponent( index : number, value : number ) : [Vector3](Vector3.html)
...
### .setFromColor( c : [Color](Color.html) ) : [Vector3](Vector3.html)
...
### .setFromCylindrical( c : [Cylindrical](Cylindrical.html) ) : [Vector3](Vector3.html)

Sets the vector components from the given cylindrical coordinates.

**c** |  The cylindrical coordinates.  
---|---  
  
**Returns:** A reference to this vector.

### .setFromCylindricalCoords( radius : number, theta : number, y : number ) : [Vector3](Vector3.html)
...
### .setFromEuler( e : [Euler](Euler.html) ) : [Vector3](Vector3.html)

Sets the vector components from the given Euler angles.

**e** |  The Euler angles to set.  
---|---  
  
**Returns:** A reference to this vector.

### .setFromMatrix3Column( m : [Matrix3](Matrix3.html), index : number ) : [Vector3](Vector3.html)
...
### .setFromMatrixColumn( m : [Matrix4](Matrix4.html), index : number ) : [Vector3](Vector3.html)
...
### .setFromMatrixPosition( m : [Matrix4](Matrix4.html) ) : [Vector3](Vector3.html)
...
### .setFromMatrixScale( m : [Matrix4](Matrix4.html) ) : [Vector3](Vector3.html)
...
### .setFromSpherical( s : [Spherical](Spherical.html) ) : [Vector3](Vector3.html)
...
### .setFromSphericalCoords( radius : number, phi : number, theta : number ) : [Vector3](Vector3.html)
...
### .setLength( length : number ) : [Vector3](Vector3.html)
...
### .setScalar( scalar : number ) : [Vector3](Vector3.html)

Sets the vector components to the same value.

**scalar** |  The value to set for all vector components.  
---|---  
  
**Returns:** A reference to this vector.

### .setX( x : number ) : [Vector3](Vector3.html)
...
### .setY( y : number ) : [Vector3](Vector3.html)
...
### .setZ( z : number ) : [Vector3](Vector3.html)
...
### .sub( v : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .subScalar( s : number ) : [Vector3](Vector3.html)
...
### .subVectors( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
**array** |  The target array holding the vector components. Default is `[]`.  
---|---  
**offset** |  Index of the first element in the array. Default is `0`.  
  
**Returns:** The vector components.

### .transformDirection( m : [Matrix4](Matrix4.html) ) : [Vector3](Vector3.html)
...
### .unproject( camera : [Camera](Camera.html) ) : [Vector3](Vector3.html)
