...
> Source: https://threejs.org/docs/pages/LatheGeometry.html
> Category: Core
...
### new LatheGeometry( points : Array.<([Vector2](Vector2.html)|[Vector3](Vector3.html))>, segments : number, phiStart : number, phiLength : number )
...
### .fromJSON( data : Object ) : [LatheGeometry](LatheGeometry.html)
