...
> Source: https://threejs.org/docs/pages/Clock.html
> Category: Core
...
**autoStart** |  Whether to automatically start the clock when `getDelta()` is called for the first time. Default is `true`.  
---|---  
