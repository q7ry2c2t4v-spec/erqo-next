...
> Source: https://threejs.org/docs/pages/DodecahedronGeometry.html
> Category: Core
...
---|---  
**detail** |  Setting this to a value greater than `0` adds vertices making it no longer a dodecahedron. Default is `0`.  
...
### .fromJSON( data : Object ) : [DodecahedronGeometry](DodecahedronGeometry.html)
