...
> Source: https://threejs.org/docs/pages/LightsNode.html
> Category: Core
...
### .outgoingLightNode : [Node](Node.html).<vec3>

A node representing the outgoing light.

### .totalDiffuseNode : [Node](Node.html).<vec3>

A node representing the total diffuse light.

### .totalSpecularNode : [Node](Node.html).<vec3>
...
### .getLights() : Array.<[Light](Light.html)>

Returns an array of the scene's lights.

**Returns:** The scene's lights.

### .setLights( lights : Array.<[Light](Light.html)> ) : [LightsNode](LightsNode.html)
...
### .setupLights( builder : [NodeBuilder](NodeBuilder.html), lightNodes : Array.<[LightingNode](LightingNode.html)> )
...
### .setupLightsNode( builder : [NodeBuilder](NodeBuilder.html) )
