...
> Source: https://threejs.org/docs/pages/AnalyticLightNode.html
> Category: Core
...
### new AnalyticLightNode( light : [Light](Light.html) )
...
### .shadowColorNode : [Node](Node.html)

Represents the light's shadow color.

Default is `null`.

### .shadowNode : [ShadowNode](ShadowNode.html)
...
### .getLightVector( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec3>
...
### .setupDirect( builder : [NodeBuilder](NodeBuilder.html) ) : Object | undefined (abstract) 
...
### .setupDirectRectArea( builder : [NodeBuilder](NodeBuilder.html) ) : Object | undefined (abstract) 
...
### .setupShadow( builder : [NodeBuilder](NodeBuilder.html) )
...
### .setupShadowNode() : [ShadowNode](ShadowNode.html)
