...
> Source: https://threejs.org/docs/pages/CubeTextureLoader.html
> Category: Core
...
### new CubeTextureLoader( manager : [LoadingManager](LoadingManager.html) )
...
**urls** |  Array of 6 URLs to images, one for each side of the cube texture. The urls should be specified in the following order: pos-x, neg-x, pos-y, neg-y, pos-z, neg-z. An array of data URIs are allowed as well.  
---|---  
