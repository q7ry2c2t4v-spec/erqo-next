...
> Source: https://threejs.org/docs/pages/ComputeBuiltinNode.html
> Category: Core
...
### .getBuiltinName( builder : [NodeBuilder](NodeBuilder.html) ) : string
...
### .hasBuiltin( builder : [NodeBuilder](NodeBuilder.html) ) : boolean
...
### .setBuiltinName( builtinName : string ) : [ComputeBuiltinNode](ComputeBuiltinNode.html)
