...
> Source: https://threejs.org/docs/pages/QuadMesh.html
> Category: Core
...
### new QuadMesh( material : [Material](Material.html) )

Constructs a new quad mesh.

**material** |  The material to render the quad mesh with. Default is `null`.  
---|---  
  
## Properties

### .camera : [OrthographicCamera](OrthographicCamera.html) (readonly) 
...
### .render( renderer : [Renderer](Renderer.html) )
...
### .renderAsync( renderer : [Renderer](Renderer.html) ) : Promise (async) 
