...
> Source: https://threejs.org/docs/pages/Vector2.html
> Category: Core
...
### .add( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .addScalar( s : number ) : [Vector2](Vector2.html)
...
### .addScaledVector( v : [Vector2](Vector2.html), s : number ) : [Vector2](Vector2.html)
...
### .addVectors( a : [Vector2](Vector2.html), b : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .angleTo( v : [Vector2](Vector2.html) ) : number
...
### .applyMatrix3( m : [Matrix3](Matrix3.html) ) : [Vector2](Vector2.html)
...
### .ceil() : [Vector2](Vector2.html)

The components of this vector are rounded up to the nearest integer value.

**Returns:** A reference to this vector.

### .clamp( min : [Vector2](Vector2.html), max : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .clampLength( min : number, max : number ) : [Vector2](Vector2.html)
...
### .clampScalar( minVal : number, maxVal : number ) : [Vector2](Vector2.html)
...
### .copy( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .cross( v : [Vector2](Vector2.html) ) : number
...
### .distanceTo( v : [Vector2](Vector2.html) ) : number
...
### .distanceToSquared( v : [Vector2](Vector2.html) ) : number
...
### .divide( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .divideScalar( scalar : number ) : [Vector2](Vector2.html)
...
### .dot( v : [Vector2](Vector2.html) ) : number
...
### .equals( v : [Vector2](Vector2.html) ) : boolean
...
### .floor() : [Vector2](Vector2.html)

The components of this vector are rounded down to the nearest integer value.

**Returns:** A reference to this vector.

### .fromArray( array : Array.<number>, offset : number ) : [Vector2](Vector2.html)
...
### .fromBufferAttribute( attribute : [BufferAttribute](BufferAttribute.html), index : number ) : [Vector2](Vector2.html)
...
**index** |  The component index. `0` equals to x, `1` equals to y.  
---|---  
...
### .lerp( v : [Vector2](Vector2.html), alpha : number ) : [Vector2](Vector2.html)
...
### .lerpVectors( v1 : [Vector2](Vector2.html), v2 : [Vector2](Vector2.html), alpha : number ) : [Vector2](Vector2.html)
...
### .manhattanDistanceTo( v : [Vector2](Vector2.html) ) : number
...
### .max( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .min( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .multiply( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .multiplyScalar( scalar : number ) : [Vector2](Vector2.html)
...
### .normalize() : [Vector2](Vector2.html)
...
### .random() : [Vector2](Vector2.html)

Sets each component of this vector to a pseudo-random value between `0` and `1`, excluding `1`.

**Returns:** A reference to this vector.

### .rotateAround( center : [Vector2](Vector2.html), angle : number ) : [Vector2](Vector2.html)
...
### .round() : [Vector2](Vector2.html)

The components of this vector are rounded to the nearest integer value

**Returns:** A reference to this vector.

### .roundToZero() : [Vector2](Vector2.html)

The components of this vector are rounded towards zero (up if negative, down if positive) to an integer value.

**Returns:** A reference to this vector.

### .set( x : number, y : number ) : [Vector2](Vector2.html)
...
### .setComponent( index : number, value : number ) : [Vector2](Vector2.html)
...
### .setLength( length : number ) : [Vector2](Vector2.html)
...
### .setScalar( scalar : number ) : [Vector2](Vector2.html)
...
### .setX( x : number ) : [Vector2](Vector2.html)
...
### .setY( y : number ) : [Vector2](Vector2.html)
...
### .sub( v : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .subScalar( s : number ) : [Vector2](Vector2.html)
...
### .subVectors( a : [Vector2](Vector2.html), b : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
