...
> Source: https://threejs.org/docs/pages/SSSLightingModel.html
> Category: Core

[LightingModel](LightingModel.html) → [PhysicalLightingModel](PhysicalLightingModel.html) → 
...
**sss** |  Whether SSS is supported or not. Default is `false`.  
...
### .direct( input : Object, builder : [NodeBuilder](NodeBuilder.html) )
