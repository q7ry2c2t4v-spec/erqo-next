...
> Source: https://threejs.org/docs/pages/ContextNode.html
> Category: Core
...
### new ContextNode( node : [Node](Node.html), value : Object )

Constructs a new context node.

**node** |  The node whose context should be modified. Default is `null`.  
---|---  
