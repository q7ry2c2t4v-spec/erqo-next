...
> Source: https://threejs.org/docs/pages/MathUtils.html
> Category: Core
...
---|---  
**array** |  The typed array that defines the data type of the value.  
...
### .setQuaternionFromProperEuler( q : [Quaternion](Quaternion.html), a : number, b : number, c : number, order : 'XYX' | 'XZX' | 'YXY' | 'YZY' | 'ZXZ' | 'ZYZ' )
