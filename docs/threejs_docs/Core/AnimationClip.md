...
> Source: https://threejs.org/docs/pages/AnimationClip.html
> Category: Core
...
### new AnimationClip( name : string, duration : number, tracks : Array.<[KeyframeTrack](KeyframeTrack.html)>, blendMode : [NormalAnimationBlendMode](global.html#NormalAnimationBlendMode) | [AdditiveAnimationBlendMode](global.html#AdditiveAnimationBlendMode) )
...
### .tracks : Array.<[KeyframeTrack](KeyframeTrack.html)>
...
### .clone() : [AnimationClip](AnimationClip.html)

Returns a new animation clip with copied values from this instance.

**Returns:** A clone of this instance.

### .optimize() : [AnimationClip](AnimationClip.html)
...
### .resetDuration() : [AnimationClip](AnimationClip.html)
...
### .trim() : [AnimationClip](AnimationClip.html)
...
### .CreateClipsFromMorphTargetSequences( morphTargets : Array.<Object>, fps : number, noLoop : boolean ) : Array.<[AnimationClip](AnimationClip.html)>
...
### .CreateFromMorphTargetSequence( name : string, morphTargetSequence : Array.<Object>, fps : number, noLoop : boolean ) : [AnimationClip](AnimationClip.html)
...
### .findByName( objectOrClipArray : Array.<[AnimationClip](AnimationClip.html)> | [Object3D](Object3D.html), name : string ) : [AnimationClip](AnimationClip.html)
...
### .parse( json : Object ) : [AnimationClip](AnimationClip.html)
...
### .parseAnimation( animation : Object, bones : Array.<[Bone](Bone.html)> ) : [AnimationClip](AnimationClip.html)
...
### .toJSON( clip : [AnimationClip](AnimationClip.html) ) : Object
