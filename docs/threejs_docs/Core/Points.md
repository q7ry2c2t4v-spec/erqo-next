...
> Source: https://threejs.org/docs/pages/Points.html
> Category: Core
...
### new Points( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)> )

Constructs a new point cloud.

**geometry** |  The points geometry.  
---|---  
**material** |  The points material.  
