...
> Source: https://threejs.org/docs/pages/ReferenceNode.html
> Category: Core
...
### .group : [UniformGroupNode](UniformGroupNode.html)
...
### .node : [UniformNode](UniformNode.html)
...
### .element( indexNode : [IndexNode](IndexNode.html) ) : [ReferenceElementNode](ReferenceElementNode.html)
...
### .getValueFromReference( object : Object ) : [any](global.html#any)
...
### .label( name : string ) : [ReferenceNode](ReferenceNode.html)
...
### .setGroup( group : [UniformGroupNode](UniformGroupNode.html) ) : [ReferenceNode](ReferenceNode.html)
...
### .setName( name : string ) : [ReferenceNode](ReferenceNode.html)
...
### .setup( builder : [NodeBuilder](NodeBuilder.html) ) : [UniformNode](UniformNode.html)
