...
> Source: https://threejs.org/docs/pages/SpotLight.html
> Category: Core
...
### new SpotLight( color : number | [Color](Color.html) | string, intensity : number, distance : number, angle : number, penumbra : number, decay : number )
...
### .shadow : [SpotLightShadow](SpotLightShadow.html)
