...
> Source: https://threejs.org/docs/pages/GLSLNodeBuilder.html
> Category: Core
...
### new GLSLNodeBuilder( object : [Object3D](Object3D.html), renderer : [Renderer](Renderer.html) )
...
### .transforms : Array.<Object.<string, ([AttributeNode](AttributeNode.html)|string)>>
...
### .generatePBO( storageArrayElementNode : [StorageArrayElementNode](StorageArrayElementNode.html) ) : string
...
### .generateTexture( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, depthSnippet : string, offsetSnippet : string ) : string
...
### .generateTextureBias( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, biasSnippet : string, depthSnippet : string, offsetSnippet : string ) : string
...
### .generateTextureGrad( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, gradSnippet : Array.<string>, depthSnippet : string, offsetSnippet : string ) : string
...
### .generateTextureLevel( texture : [Texture](Texture.html), textureProperty : string, uvSnippet : string, levelSnippet : string, depthSnippet : string, offsetSnippet : string ) : string
...
### .needsToWorkingColorSpace( texture : [Texture](Texture.html) ) : boolean
...
### .registerTransform( varyingName : string, attributeNode : [AttributeNode](AttributeNode.html) )
...
### .setupPBO( storageBufferNode : [StorageBufferNode](StorageBufferNode.html) )
