...
> Source: https://threejs.org/docs/pages/Raycaster.html
> Category: Core
...
### new Raycaster( origin : [Vector3](Vector3.html), direction : [Vector3](Vector3.html), near : number, far : number )
...
**near** |  All results returned are further away than near. Near can't be negative. Default is `0`.  
**far** |  All results returned are closer than far. Far can't be lower than near. Default is `Infinity`.  
...
### .intersectObject( object : [Object3D](Object3D.html), recursive : boolean, intersects : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)> ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)>
...
**intersects** |  The target array that holds the result of the method. Default is `[]`.  
  
**Returns:** An array holding the intersection points.

### .intersectObjects( objects : Array.<[Object3D](Object3D.html)>, recursive : boolean, intersects : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)> ) : Array.<[Raycaster~Intersection](Raycaster.html#~Intersection)>
...
### .set( origin : [Vector3](Vector3.html), direction : [Vector3](Vector3.html) )
...
### .setFromCamera( coords : [Vector2](Vector2.html), camera : [Camera](Camera.html) )
...
### .setFromXRController( controller : [WebXRController](WebXRController.html) ) : [Raycaster](Raycaster.html)
...
**distance**   
number |  The distance from the ray's origin to the intersection point.  
---|---  
**distanceToRay**   
number |  Some 3D objects e.g. [Points](Points.html) provide the distance of the intersection to the nearest point on the ray. For other objects it will be `undefined`.  
**point**   
[Vector3](Vector3.html) |  The intersection point, in world coordinates.  
**face**   
Object |  The face that has been intersected.  
**faceIndex**   
number |  The face index.  
**object**   
[Object3D](Object3D.html) |  The 3D object that has been intersected.  
**uv**   
[Vector2](Vector2.html) |  U,V coordinates at point of intersection.  
**uv1**   
[Vector2](Vector2.html) |  Second set of U,V coordinates at point of intersection.  
**normal**   
[Vector3](Vector3.html) |  Interpolated normal vector at point of intersection.  
**instanceId**   
number |  The index number of the instance where the ray intersects the [InstancedMesh](InstancedMesh.html).  
