...
> Source: https://threejs.org/docs/pages/Scene.html
> Category: Core
...
### .background : [Color](Color.html) | [Texture](Texture.html)
...
### .backgroundRotation : [Euler](Euler.html)
...
### .environmentRotation : [Euler](Euler.html)
...
### .fog : [Fog](Fog.html) | [FogExp2](FogExp2.html)
