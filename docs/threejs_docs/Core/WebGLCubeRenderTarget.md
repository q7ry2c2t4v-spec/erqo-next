...
> Source: https://threejs.org/docs/pages/WebGLCubeRenderTarget.html
> Category: Core
...
### new WebGLCubeRenderTarget( size : number, options : [RenderTarget~Options](RenderTarget.html#~Options) )
...
### .clear( renderer : [WebGLRenderer](WebGLRenderer.html), color : boolean, depth : boolean, stencil : boolean )
...
### .fromEquirectangularTexture( renderer : [WebGLRenderer](WebGLRenderer.html), texture : [Texture](Texture.html) ) : [WebGLCubeRenderTarget](WebGLCubeRenderTarget.html)
