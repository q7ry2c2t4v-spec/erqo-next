...
> Source: https://threejs.org/docs/pages/PassNode.html
> Category: Core
...
### new PassNode( scope : 'color' | 'depth', scene : [Scene](Scene.html), camera : [Camera](Camera.html), options : Object )
...
### .contextNode : [ContextNode](ContextNode.html) | null
...
### .overrideMaterial : [Material](Material.html) | null
...
### .compileAsync( renderer : [Renderer](Renderer.html) ) : Promise (async) 
...
### .getLayers() : [Layers](Layers.html)

Gets the current layer configuration of the pass.

**Returns:** .

### .getLinearDepthNode( name : string ) : [Node](Node.html)
...
### .getPreviousTexture( name : string ) : [Texture](Texture.html)
...
### .getPreviousTextureNode( name : string ) : [TextureNode](TextureNode.html)
...
### .getTexture( name : string ) : [Texture](Texture.html)
...
### .getTextureNode( name : string ) : [TextureNode](TextureNode.html)
...
### .getViewZNode( name : string ) : [Node](Node.html)
...
### .setLayers( layers : [Layers](Layers.html) ) : [PassNode](PassNode.html)
...
### .setMRT( mrt : [MRTNode](MRTNode.html) ) : [PassNode](PassNode.html)
...
### .setResolution( resolution : number ) : [PassNode](PassNode.html)
...
### .setResolutionScale( resolutionScale : number ) : [PassNode](PassNode.html)
