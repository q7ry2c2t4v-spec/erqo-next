...
### new Source( data : [any](global.html#any) )
...
### .getSize( target : [Vector2](Vector2.html) | [Vector3](Vector3.html) ) : [Vector2](Vector2.html) | [Vector3](Vector3.html)

Returns the dimensions of the source into the given target vector.

**target** |  The target object the result is written into.  
---|---  
