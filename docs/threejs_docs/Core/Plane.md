...
> Source: https://threejs.org/docs/pages/Plane.html
> Category: Core
...
### new Plane( normal : [Vector3](Vector3.html), constant : number )

Constructs a new plane.

**normal** |  A unit length vector defining the normal of the plane. Default is `(1,0,0)`.  
---|---  
...
### .normal : [Vector3](Vector3.html)

A unit length vector defining the normal of the plane.

## Methods

### .applyMatrix4( matrix : [Matrix4](Matrix4.html), optionalNormalMatrix : [Matrix4](Matrix4.html) ) : [Plane](Plane.html)
...
---|---  
**optionalNormalMatrix** |  A pre-computed normal matrix.  
  
**Returns:** A reference to this plane.

### .clone() : [Plane](Plane.html)

Returns a new plane with copied values from this instance.

**Returns:** A clone of this instance.

### .coplanarPoint( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .copy( plane : [Plane](Plane.html) ) : [Plane](Plane.html)
...
### .distanceToSphere( sphere : [Sphere](Sphere.html) ) : number
...
### .equals( plane : [Plane](Plane.html) ) : boolean

Returns `true` if this plane is equal with the given one.

**plane** |  The plane to test for equality.  
---|---  
  
**Returns:** Whether this plane is equal with the given one.

### .intersectLine( line : [Line3](Line3.html), target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
**line** |  The line to compute the intersection for.  
---|---  
**target** |  The target vector that is used to store the method's result.  
...
### .intersectsLine( line : [Line3](Line3.html) ) : boolean
...
### .negate() : [Plane](Plane.html)

Negates both the plane normal and the constant.

**Returns:** A reference to this plane.

### .normalize() : [Plane](Plane.html)

Normalizes the plane normal and adjusts the constant accordingly.

**Returns:** A reference to this plane.

### .projectPoint( point : [Vector3](Vector3.html), target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .set( normal : [Vector3](Vector3.html), constant : number ) : [Plane](Plane.html)
...
### .setComponents( x : number, y : number, z : number, w : number ) : [Plane](Plane.html)
...
### .setFromCoplanarPoints( a : [Vector3](Vector3.html), b : [Vector3](Vector3.html), c : [Vector3](Vector3.html) ) : [Plane](Plane.html)
...
### .setFromNormalAndCoplanarPoint( normal : [Vector3](Vector3.html), point : [Vector3](Vector3.html) ) : [Plane](Plane.html)
...
### .translate( offset : [Vector3](Vector3.html) ) : [Plane](Plane.html)
