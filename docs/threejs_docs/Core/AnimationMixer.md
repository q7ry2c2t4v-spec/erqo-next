...
> Source: https://threejs.org/docs/pages/AnimationMixer.html
> Category: Core
...
### new AnimationMixer( root : [Object3D](Object3D.html) )
...
### .clipAction( clip : [AnimationClip](AnimationClip.html) | string, optionalRoot : [Object3D](Object3D.html), blendMode : [NormalAnimationBlendMode](global.html#NormalAnimationBlendMode) | [AdditiveAnimationBlendMode](global.html#AdditiveAnimationBlendMode) ) : [AnimationAction](AnimationAction.html)
...
**clip** |  An animation clip or alternatively the name of the animation clip.  
---|---  
**optionalRoot** |  An alternative root object.  
**blendMode** |  The blend mode.  
  
**Returns:** The animation action.

### .existingAction( clip : [AnimationClip](AnimationClip.html) | string, optionalRoot : [Object3D](Object3D.html) ) : [AnimationAction](AnimationAction.html)
...
### .setTime( time : number ) : [AnimationMixer](AnimationMixer.html)
...
### .stopAllAction() : [AnimationMixer](AnimationMixer.html)

Deactivates all previously scheduled actions on this mixer.

**Returns:** A reference to this animation mixer.

### .uncacheAction( clip : [AnimationClip](AnimationClip.html) | string, optionalRoot : [Object3D](Object3D.html) )
...
### .uncacheClip( clip : [AnimationClip](AnimationClip.html) )
...
**clip** |  The clip to uncache.  
---|---  
  
### .uncacheRoot( root : [Object3D](Object3D.html) )
...
**root** |  The root object to uncache.  
---|---  
  
### .update( deltaTime : number ) : [AnimationMixer](AnimationMixer.html)
