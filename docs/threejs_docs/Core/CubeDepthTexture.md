...
> Source: https://threejs.org/docs/pages/CubeDepthTexture.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Texture](Texture.html) → [DepthTexture](DepthTexture.html) → 
...
**size** |  The size (width and height) of each cube face.  
---|---  
