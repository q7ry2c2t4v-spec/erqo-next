...
### .getViewBounds( distance : number, minTarget : [Vector2](Vector2.html), maxTarget : [Vector2](Vector2.html) )
...
### .getViewSize( distance : number, target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
