...
> Source: https://threejs.org/docs/pages/Sprite.html
> Category: Core
...
### new Sprite( material : [SpriteMaterial](SpriteMaterial.html) | [SpriteNodeMaterial](SpriteNodeMaterial.html) )
...
### .material : [SpriteMaterial](SpriteMaterial.html) | [SpriteNodeMaterial](SpriteNodeMaterial.html)
