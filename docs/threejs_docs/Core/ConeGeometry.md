...
> Source: https://threejs.org/docs/pages/ConeGeometry.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [BufferGeometry](BufferGeometry.html) → [CylinderGeometry](CylinderGeometry.html) → 
...
### .fromJSON( data : Object ) : [ConeGeometry](ConeGeometry.html)
