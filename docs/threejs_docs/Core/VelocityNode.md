...
> Source: https://threejs.org/docs/pages/VelocityNode.html
> Category: Core
...
### .previousCameraViewMatrix : [UniformNode](UniformNode.html).<mat4>

Uniform node representing the previous view matrix.

Default is `null`.

### .previousModelWorldMatrix : [UniformNode](UniformNode.html).<mat4>

Uniform node representing the previous model matrix in world space.

Default is `null`.

### .previousProjectionMatrix : [UniformNode](UniformNode.html).<mat4>
...
### .setProjectionMatrix( projectionMatrix : [Matrix4](Matrix4.html) )
...
### .setup( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec2>
...
### .updateAfter( frame : [NodeFrame](NodeFrame.html) )
