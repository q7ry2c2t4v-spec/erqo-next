...
> Source: https://threejs.org/docs/pages/PointShadowNode.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Node](Node.html) → [ShadowBaseNode](ShadowBaseNode.html) → [ShadowNode](ShadowNode.html) → 
...
### new PointShadowNode( light : [PointLight](PointLight.html), shadow : [PointLightShadow](PointLightShadow.html) )
...
### .setupRenderTarget( shadow : [LightShadow](LightShadow.html), builder : [NodeBuilder](NodeBuilder.html) ) : Object

Overwrites the default implementation to create a CubeRenderTarget with CubeDepthTexture.

**shadow** |  The light shadow object.  
---|---  
...
---|---  
**depthTexture** |  A reference to the shadow map's depth texture.  
