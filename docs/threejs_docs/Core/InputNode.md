...
> Source: https://threejs.org/docs/pages/InputNode.html
> Category: Core
...
### new InputNode( value : [any](global.html#any), nodeType : string )

Constructs a new input node.

**value** |  The value of this node. This can be any JS primitive, functions, array buffers or even three.js objects (vector, matrices, colors).  
---|---  
...
### .setPrecision( precision : 'low' | 'medium' | 'high' ) : [InputNode](InputNode.html)
...
**precision** |  The precision of the input value in the shader.  
---|---  
