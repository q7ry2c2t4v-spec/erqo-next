...
> Source: https://threejs.org/docs/pages/CatmullRomCurve3.html
> Category: Core
...
### new CatmullRomCurve3( points : Array.<[Vector3](Vector3.html)>, closed : boolean, curveType : 'centripetal' | 'chordal' | 'catmullrom', tension : number )
...
### .points : Array.<[Vector3](Vector3.html)>
