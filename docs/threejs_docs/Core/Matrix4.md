...
> Source: https://threejs.org/docs/pages/Matrix4.html
> Category: Core
...
**n14** |  1-4 matrix element.  
**n21** |  2-1 matrix element.  
**n22** |  2-2 matrix element.  
**n23** |  2-3 matrix element.  
**n24** |  2-4 matrix element.  
**n31** |  3-1 matrix element.  
**n32** |  3-2 matrix element.  
**n33** |  3-3 matrix element.  
**n34** |  3-4 matrix element.  
**n41** |  4-1 matrix element.  
**n42** |  4-2 matrix element.  
**n43** |  4-3 matrix element.  
**n44** |  4-4 matrix element.  
...
### .clone() : [Matrix4](Matrix4.html)

Returns a matrix with copied values from this instance.

**Returns:** A clone of this instance.

### .compose( position : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), scale : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .copy( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .copyPosition( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)

Copies the translation component of the given matrix into this matrix's translation component.

**m** |  The matrix to copy the translation component.  
---|---  
  
**Returns:** A reference to this matrix.

### .decompose( position : [Vector3](Vector3.html), quaternion : [Quaternion](Quaternion.html), scale : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .equals( matrix : [Matrix4](Matrix4.html) ) : boolean
...
### .extractBasis( xAxis : [Vector3](Vector3.html), yAxis : [Vector3](Vector3.html), zAxis : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .extractRotation( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .fromArray( array : Array.<number>, offset : number ) : [Matrix4](Matrix4.html)
...
### .identity() : [Matrix4](Matrix4.html)

Sets this matrix to the 4x4 identity matrix.

**Returns:** A reference to this matrix.

### .invert() : [Matrix4](Matrix4.html)
...
### .lookAt( eye : [Vector3](Vector3.html), target : [Vector3](Vector3.html), up : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .makeBasis( xAxis : [Vector3](Vector3.html), yAxis : [Vector3](Vector3.html), zAxis : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .makeOrthographic( left : number, right : number, top : number, bottom : number, near : number, far : number, coordinateSystem : [WebGLCoordinateSystem](global.html#WebGLCoordinateSystem) | [WebGPUCoordinateSystem](global.html#WebGPUCoordinateSystem), reversedDepth : boolean ) : [Matrix4](Matrix4.html)
...
**left** |  Left boundary of the viewing frustum at the near plane.  
---|---  
**right** |  Right boundary of the viewing frustum at the near plane.  
**top** |  Top boundary of the viewing frustum at the near plane.  
**bottom** |  Bottom boundary of the viewing frustum at the near plane.  
**near** |  The distance from the camera to the near plane.  
**far** |  The distance from the camera to the far plane.  
**coordinateSystem** |  The coordinate system. Default is `WebGLCoordinateSystem`.  
**reversedDepth** |  Whether to use a reversed depth. Default is `false`.  
  
**Returns:** A reference to this matrix.

### .makePerspective( left : number, right : number, top : number, bottom : number, near : number, far : number, coordinateSystem : [WebGLCoordinateSystem](global.html#WebGLCoordinateSystem) | [WebGPUCoordinateSystem](global.html#WebGPUCoordinateSystem), reversedDepth : boolean ) : [Matrix4](Matrix4.html)
...
### .makeRotationAxis( axis : [Vector3](Vector3.html), angle : number ) : [Matrix4](Matrix4.html)
...
### .makeRotationFromEuler( euler : [Euler](Euler.html) ) : [Matrix4](Matrix4.html)
...
### .makeRotationFromQuaternion( q : [Quaternion](Quaternion.html) ) : [Matrix4](Matrix4.html)
...
### .makeRotationX( theta : number ) : [Matrix4](Matrix4.html)
...
### .makeRotationY( theta : number ) : [Matrix4](Matrix4.html)
...
### .makeRotationZ( theta : number ) : [Matrix4](Matrix4.html)
...
### .makeScale( x : number, y : number, z : number ) : [Matrix4](Matrix4.html)
...
### .makeShear( xy : number, xz : number, yx : number, yz : number, zx : number, zy : number ) : [Matrix4](Matrix4.html)
...
### .makeTranslation( x : number | [Vector3](Vector3.html), y : number, z : number ) : [Matrix4](Matrix4.html)
...
### .multiply( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .multiplyMatrices( a : [Matrix4](Matrix4.html), b : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .multiplyScalar( s : number ) : [Matrix4](Matrix4.html)
...
### .premultiply( m : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .scale( v : [Vector3](Vector3.html) ) : [Matrix4](Matrix4.html)
...
### .set( n11 : number, n12 : number, n13 : number, n14 : number, n21 : number, n22 : number, n23 : number, n24 : number, n31 : number, n32 : number, n33 : number, n34 : number, n41 : number, n42 : number, n43 : number, n44 : number ) : [Matrix4](Matrix4.html)
...
### .setFromMatrix3( m : [Matrix3](Matrix3.html) ) : [Matrix4](Matrix4.html)
...
### .setPosition( x : number | [Vector3](Vector3.html), y : number, z : number ) : [Matrix4](Matrix4.html)

Sets the position component for this matrix from the given vector, without affecting the rest of the matrix.

**x** |  The x component of the vector or alternatively the vector object.  
---|---  
...
### .transpose() : [Matrix4](Matrix4.html)
