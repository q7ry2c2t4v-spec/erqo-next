...
> Source: https://threejs.org/docs/pages/SampleNode.html
> Category: Core
...
### new SampleNode( callback : function, uvNode : [Node](Node.html).<vec2> )
...
### .sample( uv : [Node](Node.html).<vec2> ) : [Node](Node.html)
