...
> Source: https://threejs.org/docs/pages/OutputStructNode.html
> Category: Core
...
### new OutputStructNode( …members : [Node](Node.html) )
...
**members** |  A parameter list of nodes.  
---|---  
