...
> Source: https://threejs.org/docs/pages/AnimationLoader.html
> Category: Core
...
### new AnimationLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( json : Object ) : Array.<[AnimationClip](AnimationClip.html)>

Parses the given JSON object and returns an array of animation clips.

**json** |  The serialized animation clips.  
---|---  
