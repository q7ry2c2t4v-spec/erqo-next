...
> Source: https://threejs.org/docs/pages/BufferGeometryLoader.html
> Category: Core
...
### new BufferGeometryLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( json : Object ) : [BufferGeometry](BufferGeometry.html)

Parses the given JSON object and returns a geometry.

**json** |  The serialized geometry.  
---|---  
