...
> Source: https://threejs.org/docs/pages/WebGL3DRenderTarget.html
> Category: Core
...
### new WebGL3DRenderTarget( width : number, height : number, depth : number, options : [RenderTarget~Options](RenderTarget.html#~Options) )
