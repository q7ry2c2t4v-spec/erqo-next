...
> Source: https://threejs.org/docs/pages/Quaternion.html
> Category: Core
...
**x** |  The x value of this quaternion. Default is `0`.  
---|---  
**y** |  The y value of this quaternion. Default is `0`.  
**z** |  The z value of this quaternion. Default is `0`.  
**w** |  The w value of this quaternion. Default is `1`.  
...
### .angleTo( q : [Quaternion](Quaternion.html) ) : number

Returns the angle between this quaternion and the given one in radians.

**q** |  The quaternion to compute the angle with.  
---|---  
...
### .conjugate() : [Quaternion](Quaternion.html)

Returns the rotational conjugate of this quaternion. The conjugate of a quaternion represents the same rotation in the opposite direction about the rotational axis.

**Returns:** A reference to this quaternion.

### .copy( quaternion : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .dot( v : [Quaternion](Quaternion.html) ) : number

Calculates the dot product of this quaternion and the given one.

**v** |  The quaternion to compute the dot product with.  
---|---  
  
**Returns:** The result of the dot product.

### .equals( quaternion : [Quaternion](Quaternion.html) ) : boolean

Returns `true` if this quaternion is equal with the given one.

**quaternion** |  The quaternion to test for equality.  
---|---  
  
**Returns:** Whether this quaternion is equal with the given one.

### .fromArray( array : Array.<number>, offset : number ) : [Quaternion](Quaternion.html)

Sets this quaternion's components from the given array.

**array** |  An array holding the quaternion component values.  
---|---  
**offset** |  The offset into the array. Default is `0`.  
  
**Returns:** A reference to this quaternion.

### .fromBufferAttribute( attribute : [BufferAttribute](BufferAttribute.html), index : number ) : [Quaternion](Quaternion.html)

Sets the components of this quaternion from the given buffer attribute.

**attribute** |  The buffer attribute holding quaternion data.  
---|---  
**index** |  The index into the attribute.  
  
**Returns:** A reference to this quaternion.

### .identity() : [Quaternion](Quaternion.html)

Sets this quaternion to the identity quaternion; that is, to the quaternion that represents "no rotation".

**Returns:** A reference to this quaternion.

### .invert() : [Quaternion](Quaternion.html)
...
### .multiply( q : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .multiplyQuaternions( a : [Quaternion](Quaternion.html), b : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .premultiply( q : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)
...
### .random() : [Quaternion](Quaternion.html)

Sets this quaternion to a uniformly random, normalized quaternion.

**Returns:** A reference to this quaternion.

### .rotateTowards( q : [Quaternion](Quaternion.html), step : number ) : [Quaternion](Quaternion.html)
...
### .set( x : number, y : number, z : number, w : number ) : [Quaternion](Quaternion.html)

Sets the quaternion components.

**x** |  The x value of this quaternion.  
---|---  
**y** |  The y value of this quaternion.  
**z** |  The z value of this quaternion.  
**w** |  The w value of this quaternion.  
  
**Returns:** A reference to this quaternion.

### .setFromAxisAngle( axis : [Vector3](Vector3.html), angle : number ) : [Quaternion](Quaternion.html)
...
### .setFromEuler( euler : [Euler](Euler.html), update : boolean ) : [Quaternion](Quaternion.html)
...
### .setFromRotationMatrix( m : [Matrix4](Matrix4.html) ) : [Quaternion](Quaternion.html)
...
### .setFromUnitVectors( vFrom : [Vector3](Vector3.html), vTo : [Vector3](Vector3.html) ) : [Quaternion](Quaternion.html)

Sets this quaternion to the rotation required to rotate the direction vector `vFrom` to the direction vector `vTo`.

**vFrom** |  The first (normalized) direction vector.  
---|---  
**vTo** |  The second (normalized) direction vector.  
  
**Returns:** A reference to this quaternion.

### .slerp( qb : [Quaternion](Quaternion.html), t : number ) : [Quaternion](Quaternion.html)

Performs a spherical linear interpolation between this quaternion and the target quaternion.

**qb** |  The target quaternion.  
---|---  
**t** |  The interpolation factor. A value in the range `[0,1]` will interpolate. A value outside the range `[0,1]` will extrapolate.  
  
**Returns:** A reference to this quaternion.

### .slerpQuaternions( qa : [Quaternion](Quaternion.html), qb : [Quaternion](Quaternion.html), t : number ) : [Quaternion](Quaternion.html)

Performs a spherical linear interpolation between the given quaternions and stores the result in this quaternion.

**qa** |  The source quaternion.  
---|---  
**qb** |  The target quaternion.  
...
**array** |  The target array holding the quaternion components. Default is `[]`.  
---|---  
...
**srcOffset0** |  An offset into the first source array.  
**src1** |  The source array of the second quaternion.  
**srcOffset1** |  An offset into the second source array.  
