...
### new InstancedMesh( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)>, count : number )
...
### .morphTexture : [DataTexture](DataTexture.html)
...
### .previousInstanceMatrix : [InstancedBufferAttribute](InstancedBufferAttribute.html)
...
### .getColorAt( index : number, color : [Color](Color.html) )
...
### .getMatrixAt( index : number, matrix : [Matrix4](Matrix4.html) )
...
### .getMorphAt( index : number, object : [Mesh](Mesh.html) )
...
### .setColorAt( index : number, color : [Color](Color.html) )
...
### .setMatrixAt( index : number, matrix : [Matrix4](Matrix4.html) )
...
### .setMorphAt( index : number, object : [Mesh](Mesh.html) )
