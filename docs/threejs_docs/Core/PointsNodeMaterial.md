...
> Source: https://threejs.org/docs/pages/PointsNodeMaterial.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Material](Material.html) → [NodeMaterial](NodeMaterial.html) → [SpriteNodeMaterial](SpriteNodeMaterial.html) → 
