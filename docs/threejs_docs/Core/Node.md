...
> Source: https://threejs.org/docs/pages/Node.html
> Category: Core
...
### .analyze( builder : [NodeBuilder](NodeBuilder.html), output : [Node](Node.html) )
...
---|---  
**output** |  The target output node. Default is `null`.  
  
### .build( builder : [NodeBuilder](NodeBuilder.html), output : string | [Node](Node.html) ) : [Node](Node.html) | string
...
**builder** |  The current node builder.  
---|---  
**output** |  Can be used to define the output type. Default is `null`.  
...
**builder** |  The current node builder.  
---|---  
**output** |  Can be used to define the output type.  
...
### .getCacheKey( force : boolean, ignores : Set.<[Node](Node.html)> ) : number

Returns the cache key for this node.

**force** |  When set to `true`, a recomputation of the cache key is forced. Default is `false`.  
---|---  
**ignores** |  A set of nodes to ignore during the computation of the cache key. Default is `null`.  
  
**Returns:** The cache key of the node.

### .getChildren() : [Node](Node.html) (generator) 
...
### .getShared( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html)
...
### .getUpdateAfterType() : [NodeUpdateType](global.html#NodeUpdateType)

Returns the update type of [Node#updateAfter](Node.html#updateAfter).

**Returns:** The update type.

### .getUpdateBeforeType() : [NodeUpdateType](global.html#NodeUpdateType)

Returns the update type of [Node#updateBefore](Node.html#updateBefore).

**Returns:** The update type.

### .getUpdateType() : [NodeUpdateType](global.html#NodeUpdateType)

Returns the update type of [Node#update](Node.html#update).

**Returns:** The update type.

### .isGlobal( builder : [NodeBuilder](NodeBuilder.html) ) : boolean
...
### .onFrameUpdate( callback : function ) : [Node](Node.html)
...
**callback** |  The update method.  
---|---  
  
**Returns:** A reference to this node.

### .onObjectUpdate( callback : function ) : [Node](Node.html)
...
### .onReference( callback : function ) : [Node](Node.html)
...
### .onRenderUpdate( callback : function ) : [Node](Node.html)
...
### .onUpdate( callback : function, updateType : string ) : [Node](Node.html)
...
**meta** |  An optional JSON object that already holds serialized data from other scene objects.  
---|---  
  
**Returns:** The serialized node.

### .traverse( callback : [traverseCallback](global.html#traverseCallback) )

Can be used to traverse through the node's hierarchy.

**callback** |  A callback that is executed per node.  
---|---  
  
### .update( frame : [NodeFrame](NodeFrame.html) ) : boolean (abstract) 
...
### .updateAfter( frame : [NodeFrame](NodeFrame.html) ) : boolean (abstract) 
...
### .updateBefore( frame : [NodeFrame](NodeFrame.html) ) : boolean (abstract) 
...
### .updateReference( state : [any](global.html#any) ) : [any](global.html#any)
