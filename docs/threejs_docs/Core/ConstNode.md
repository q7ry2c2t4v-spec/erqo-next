...
> Source: https://threejs.org/docs/pages/ConstNode.html
> Category: Core
...
### new ConstNode( value : [any](global.html#any), nodeType : string )
...
### .generateConst( builder : [NodeBuilder](NodeBuilder.html) ) : string
