...
> Source: https://threejs.org/docs/pages/MeshPhysicalNodeMaterial.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Material](Material.html) → [NodeMaterial](NodeMaterial.html) → [MeshStandardNodeMaterial](MeshStandardNodeMaterial.html) → 
...
### .anisotropyNode : [Node](Node.html).<float>
...
### .attenuationColorNode : [Node](Node.html).<vec3>
...
### .attenuationDistanceNode : [Node](Node.html).<float>
...
### .clearcoatNode : [Node](Node.html).<float>
...
### .clearcoatNormalNode : [Node](Node.html).<vec3>
...
### .clearcoatRoughnessNode : [Node](Node.html).<float>
...
### .dispersionNode : [Node](Node.html).<float>
...
### .iridescenceIORNode : [Node](Node.html).<float>
...
### .iridescenceNode : [Node](Node.html).<float>
...
### .iridescenceThicknessNode : [Node](Node.html).<float>
...
### .sheenRoughnessNode : [Node](Node.html).<float>
...
### .specularColorNode : [Node](Node.html).<vec3>
...
### .specularIntensityNode : [Node](Node.html).<float>
...
### .thicknessNode : [Node](Node.html).<float>
...
### .transmissionNode : [Node](Node.html).<float>
...
### .setupClearcoatNormal() : [Node](Node.html).<vec3>

Setups the clearcoat normal node.

**Returns:** The clearcoat normal.

### .setupLightingModel() : [PhysicalLightingModel](PhysicalLightingModel.html)
