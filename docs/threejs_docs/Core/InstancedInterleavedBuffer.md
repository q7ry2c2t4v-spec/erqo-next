...
> Source: https://threejs.org/docs/pages/InstancedInterleavedBuffer.html
> Category: Core
...
**meshPerAttribute** |  Defines how often a value of this interleaved buffer should be repeated. Default is `1`.  
