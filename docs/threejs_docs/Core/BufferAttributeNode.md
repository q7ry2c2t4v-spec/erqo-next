...
> Source: https://threejs.org/docs/pages/BufferAttributeNode.html
> Category: Core
...
### new BufferAttributeNode( value : [BufferAttribute](BufferAttribute.html) | [InterleavedBuffer](InterleavedBuffer.html) | TypedArray, bufferType : string, bufferStride : number, bufferOffset : number )
...
### .attribute : [BufferAttribute](BufferAttribute.html)
...
### .setInstanced( value : boolean ) : [BufferAttributeNode](BufferAttributeNode.html)
...
### .setUsage( value : number ) : [BufferAttributeNode](BufferAttributeNode.html)
