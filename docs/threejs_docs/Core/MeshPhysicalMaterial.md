...
> Source: https://threejs.org/docs/pages/MeshPhysicalMaterial.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Material](Material.html) → [MeshStandardMaterial](MeshStandardMaterial.html) → 
...
**parameters** |  An object with one or more properties defining the material's appearance. Any property of the material (including any property from inherited materials) can be passed in here. Color values can be passed any type of value accepted by [Color#set](Color.html#set).  
---|---  
...
### .anisotropyMap : [Texture](Texture.html)
...
### .attenuationColor : [Color](Color.html)
...
### .clearcoatRoughnessMap : [Texture](Texture.html)
...
### .sheenColor : [Color](Color.html)

The sheen tint.

Default is `(0,0,0)`.

### .sheenColorMap : [Texture](Texture.html)
...
### .specularIntensityMap : [Texture](Texture.html)
...
### .thicknessMap : [Texture](Texture.html)
...
### .transmissionMap : [Texture](Texture.html)
