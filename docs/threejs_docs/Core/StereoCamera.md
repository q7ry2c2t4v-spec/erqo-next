...
> Source: https://threejs.org/docs/pages/StereoCamera.html
> Category: Core
...
### .cameraL : [PerspectiveCamera](PerspectiveCamera.html)
...
### .cameraR : [PerspectiveCamera](PerspectiveCamera.html)
...
### .update( camera : [PerspectiveCamera](PerspectiveCamera.html) )
