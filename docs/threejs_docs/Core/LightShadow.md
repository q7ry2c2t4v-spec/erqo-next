...
> Source: https://threejs.org/docs/pages/LightShadow.html
> Category: Core
...
### new LightShadow( camera : [Camera](Camera.html) ) (abstract) 
...
### .map : [RenderTarget](RenderTarget.html)

The depth map generated using the internal camera; a location beyond a pixel's depth is in shadow. Computed internally during rendering.

Default is `null`.

### .mapPass : [RenderTarget](RenderTarget.html)

The distribution map generated using the internal camera; an occlusion is calculated based on the distribution of depths. Computed internally during rendering.

Default is `null`.

### .mapSize : [Vector2](Vector2.html)
...
### .clone() : [LightShadow](LightShadow.html)

Returns a new light shadow instance with copied values from this instance.

**Returns:** A clone of this instance.

### .copy( source : [LightShadow](LightShadow.html) ) : [LightShadow](LightShadow.html)
...
### .getFrameExtents() : [Vector2](Vector2.html)

Returns the frame extends.

**Returns:** The frame extends.

### .getFrustum() : [Frustum](Frustum.html)

Gets the shadow cameras frustum. Used internally by the renderer to cull objects.

**Returns:** The shadow camera frustum.

### .getViewport( viewportIndex : number ) : [Vector4](Vector4.html)
...
### .updateMatrices( light : [Light](Light.html) )
