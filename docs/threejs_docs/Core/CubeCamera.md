...
> Source: https://threejs.org/docs/pages/CubeCamera.html
> Category: Core
...
### new CubeCamera( near : number, far : number, renderTarget : [WebGLCubeRenderTarget](WebGLCubeRenderTarget.html) )
...
### .renderTarget : [WebGLCubeRenderTarget](WebGLCubeRenderTarget.html)

A reference to the cube render target.

## Methods

### .update( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), scene : [Scene](Scene.html) )
