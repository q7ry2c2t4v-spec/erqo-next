...
> Source: https://threejs.org/docs/pages/BoxHelper.html
> Category: Core
...
### new BoxHelper( object : [Object3D](Object3D.html), color : number | [Color](Color.html) | string )
...
### .setFromObject( object : [Object3D](Object3D.html) ) : [BoxHelper](BoxHelper.html)
