...
> Source: https://threejs.org/docs/pages/VarNode.html
> Category: Core
...
### new VarNode( node : [Node](Node.html), name : string, readOnly : boolean )
...
### .isIntent( builder : [NodeBuilder](NodeBuilder.html) ) : boolean
...
### .setIntent( value : boolean ) : [VarNode](VarNode.html)
