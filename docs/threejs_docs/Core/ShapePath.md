...
> Source: https://threejs.org/docs/pages/ShapePath.html
> Category: Core
...
### .currentPath : [Path](Path.html)

The current path that is being generated.

Default is `null`.

### .subPaths : Array.<[Path](Path.html)>
...
### .bezierCurveTo( aCP1x : number, aCP1y : number, aCP2x : number, aCP2y : number, aX : number, aY : number ) : [ShapePath](ShapePath.html)
...
### .lineTo( x : number, y : number ) : [ShapePath](ShapePath.html)
...
### .moveTo( x : number, y : number ) : [ShapePath](ShapePath.html)
...
### .quadraticCurveTo( aCPx : number, aCPy : number, aX : number, aY : number ) : [ShapePath](ShapePath.html)
...
### .splineThru( pts : Array.<[Vector2](Vector2.html)> ) : [ShapePath](ShapePath.html)
...
### .toShapes( isCCW : boolean ) : Array.<[Shape](Shape.html)>
