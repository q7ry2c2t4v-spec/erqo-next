...
> Source: https://threejs.org/docs/pages/MeshStandardNodeMaterial.html
> Category: Core
...
### .emissiveNode : [Node](Node.html).<vec3>
...
### .roughnessNode : [Node](Node.html).<float>
...
### .setupEnvironment( builder : [NodeBuilder](NodeBuilder.html) ) : [EnvironmentNode](EnvironmentNode.html).<vec3>
