...
### .attributes : Object.<string, ([BufferAttribute](BufferAttribute.html)|[InterleavedBufferAttribute](InterleavedBufferAttribute.html))>
...
### .boundingBox : [Box3](Box3.html)

Bounding box for the geometry which can be calculated with `computeBoundingBox()`.

Default is `null`.

### .boundingSphere : [Sphere](Sphere.html)
...
**start** |  The first element in this draw call. That is the first vertex for non-indexed geometry, otherwise the first triangle index.  
---|---  
**count** |  Specifies how many vertices (or indices) are part of this group.  
**materialIndex** |  The material array index to use. Default is `0`.  
  
### .applyMatrix4( matrix : [Matrix4](Matrix4.html) ) : [BufferGeometry](BufferGeometry.html)
...
### .applyQuaternion( q : [Quaternion](Quaternion.html) ) : [BufferGeometry](BufferGeometry.html)
...
### .center() : [BufferGeometry](BufferGeometry.html)
...
### .clone() : [BufferGeometry](BufferGeometry.html)
...
### .copy( source : [BufferGeometry](BufferGeometry.html) ) : [BufferGeometry](BufferGeometry.html)
...
### .deleteAttribute( name : string ) : [BufferGeometry](BufferGeometry.html)
...
### .getAttribute( name : string ) : [BufferAttribute](BufferAttribute.html) | [InterleavedBufferAttribute](InterleavedBufferAttribute.html) | undefined
...
### .getIndex() : [BufferAttribute](BufferAttribute.html)

Returns the index of this geometry.

**Returns:** The index. Returns `null` if no index is defined.

### .getIndirect() : [BufferAttribute](BufferAttribute.html)
...
### .lookAt( vector : [Vector3](Vector3.html) ) : [BufferGeometry](BufferGeometry.html)
...
### .rotateX( angle : number ) : [BufferGeometry](BufferGeometry.html)
...
### .rotateY( angle : number ) : [BufferGeometry](BufferGeometry.html)
...
### .rotateZ( angle : number ) : [BufferGeometry](BufferGeometry.html)
...
### .scale( x : number, y : number, z : number ) : [BufferGeometry](BufferGeometry.html)
...
### .setAttribute( name : string, attribute : [BufferAttribute](BufferAttribute.html) | [InterleavedBufferAttribute](InterleavedBufferAttribute.html) ) : [BufferGeometry](BufferGeometry.html)
...
**start** |  The first vertex for non-indexed geometry, otherwise the first triangle index.  
---|---  
**count** |  For non-indexed BufferGeometry, `count` is the number of vertices to render. For indexed BufferGeometry, `count` is the number of indices to render.  
  
### .setFromPoints( points : Array.<[Vector2](Vector2.html)> | Array.<[Vector3](Vector3.html)> ) : [BufferGeometry](BufferGeometry.html)
...
### .setIndex( index : Array.<number> | [BufferAttribute](BufferAttribute.html) ) : [BufferGeometry](BufferGeometry.html)
...
### .setIndirect( indirect : [BufferAttribute](BufferAttribute.html), indirectOffset : number | Array.<number> ) : [BufferGeometry](BufferGeometry.html)

Sets the given indirect attribute to this geometry.

**indirect** |  The attribute holding indirect draw calls.  
---|---  
**indirectOffset** |  The offset, in bytes, into the indirect drawing buffer where the value data begins. If an array is provided, multiple indirect draw calls will be made for each offset. Default is `0`.  
...
### .toNonIndexed() : [BufferGeometry](BufferGeometry.html)
...
### .translate( x : number, y : number, z : number ) : [BufferGeometry](BufferGeometry.html)
