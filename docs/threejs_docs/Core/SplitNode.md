...
> Source: https://threejs.org/docs/pages/SplitNode.html
> Category: Core
...
### new SplitNode( node : [Node](Node.html), components : string )
...
### .getComponentType( builder : [NodeBuilder](NodeBuilder.html) ) : string
