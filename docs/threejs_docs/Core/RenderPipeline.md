...
> Source: https://threejs.org/docs/pages/RenderPipeline.html
> Category: Core
...
### new RenderPipeline( renderer : [Renderer](Renderer.html), outputNode : [Node](Node.html).<vec4> )
...
### .needsUpdate : [Node](Node.html).<vec4>
