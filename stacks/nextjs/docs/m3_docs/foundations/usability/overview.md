...
Aspect Definition Efficiency Users can efficiently complete tasks and goals Errors Proper design reduces the likelihood of mistakes, and users can easily correct any errors that do occur Learnability New users learn to use the product and complete tasks easily, even if it’s the first time they’re using it Memorability When users come back to a product, they remember how to use it Satisfaction Users are satisfied with the designed experience
