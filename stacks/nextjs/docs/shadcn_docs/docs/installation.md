...
[Next.jsNext.js](/docs/installation/next)[ViteVite](/docs/installation/vite)[TanStack Start](/docs/installation/tanstack)[Laravel](/docs/installation/laravel)[React Router](/docs/installation/react-router)[AstroAstro](/docs/installation/astro)[ReactManual](/docs/installation/manual)

[ Introduction](/docs)[components.json ](/docs/components-json)

On This Page

Quick StartPick Your Framework
