...
> Source: https://threejs.org/docs/pages/ChromaticAberrationNode.html
> Category: Addons
...
### new ChromaticAberrationNode( textureNode : [TextureNode](TextureNode.html), strengthNode : [Node](Node.html), centerNode : [Node](Node.html), scaleNode : [Node](Node.html) )
