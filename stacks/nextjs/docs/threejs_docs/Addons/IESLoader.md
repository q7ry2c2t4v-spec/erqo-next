...
> Source: https://threejs.org/docs/pages/IESLoader.html
> Category: Addons
...
### new IESLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( text : string ) : [DataTexture](DataTexture.html)
