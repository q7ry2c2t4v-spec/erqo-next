...
> Source: https://threejs.org/docs/pages/AnaglyphEffect.html
> Category: Addons
...
### new AnaglyphEffect( renderer : [WebGLRenderer](WebGLRenderer.html), width : number, height : number )

Constructs a new anaglyph effect.

**renderer** |  The renderer.  
---|---  
**width** |  The width of the effect in physical pixels. Default is `512`.  
**height** |  The height of the effect in physical pixels. Default is `512`.  
