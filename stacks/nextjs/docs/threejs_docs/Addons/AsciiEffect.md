...
> Source: https://threejs.org/docs/pages/AsciiEffect.html
> Category: Addons
...
### new AsciiEffect( renderer : [WebGLRenderer](WebGLRenderer.html), charSet : string, options : [AsciiEffect~Options](AsciiEffect.html#~Options) )
