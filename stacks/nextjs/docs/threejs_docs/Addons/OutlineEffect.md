...
> Source: https://threejs.org/docs/pages/OutlineEffect.html
> Category: Addons
...
### new OutlineEffect( renderer : [WebGLRenderer](WebGLRenderer.html), parameters : [OutlineEffect~Options](OutlineEffect.html#~Options) )
...
### .renderOutline( scene : [Object3D](Object3D.html), camera : [Camera](Camera.html) )
...
**defaultThickness**   
number |  The outline thickness. Default is `0.003`.  
---|---  
**defaultColor**   
Array.<number> |  The outline color. Default is `[0,0,0]`.  
**defaultAlpha**   
number |  The outline alpha value. Default is `1`.  
**defaultKeepAlive**   
boolean |  Whether to keep alive cached internal materials or not. Default is `false`.  
