...
> Source: https://threejs.org/docs/pages/VertexTangentsHelper.html
> Category: Addons
...
### new VertexTangentsHelper( object : [Object3D](Object3D.html), size : number, color : number | [Color](Color.html) | string )
