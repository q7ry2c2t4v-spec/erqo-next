...
> Source: https://threejs.org/docs/pages/VTKLoader.html
> Category: Addons
...
### new VTKLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( data : ArrayBuffer ) : [BufferGeometry](BufferGeometry.html)
