...
### new KTX2Loader( manager : [LoadingManager](LoadingManager.html) )
...
### .detectSupport( renderer : [WebGPURenderer](WebGPURenderer.html) | [WebGLRenderer](WebGLRenderer.html) ) : [KTX2Loader](KTX2Loader.html)
...
### .detectSupportAsync( renderer : [WebGPURenderer](WebGPURenderer.html) ) : Promise (async) 
...
### .parse( buffer : ArrayBuffer, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) ) : Promise
...
### .setTranscoderPath( path : string ) : [KTX2Loader](KTX2Loader.html)
...
### .setWorkerLimit( workerLimit : number ) : [KTX2Loader](KTX2Loader.html)
