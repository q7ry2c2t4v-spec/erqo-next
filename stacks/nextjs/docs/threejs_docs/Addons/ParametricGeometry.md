...
> Source: https://threejs.org/docs/pages/ParametricGeometry.html
> Category: Addons
...
### new ParametricGeometry( func : [ParametricGeometry~Func](ParametricGeometry.html#~Func), slices : number, stacks : number )
...
### .Func( u : number, v : number, target : [Vector3](Vector3.html) )
