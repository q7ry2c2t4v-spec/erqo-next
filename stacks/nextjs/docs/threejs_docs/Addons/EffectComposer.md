...
> Source: https://threejs.org/docs/pages/EffectComposer.html
> Category: Addons
...
### new EffectComposer( renderer : [WebGLRenderer](WebGLRenderer.html), renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html) )
...
### .passes : Array.<[Pass](Pass.html)>

An array representing the (ordered) chain of post-processing passes.

### .readBuffer : [WebGLRenderTarget](WebGLRenderTarget.html)
...
### .insertPass( pass : [Pass](Pass.html), index : number )
...
### .removePass( pass : [Pass](Pass.html) )
...
### .reset( renderTarget : [WebGLRenderTarget](WebGLRenderTarget.html) )
