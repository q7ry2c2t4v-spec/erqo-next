...
> Source: https://threejs.org/docs/pages/InstancedFlow.html
> Category: Addons
...
### new InstancedFlow( count : number, curveCount : number, geometry : Geometry, material : [Material](Material.html) )

Constructs a new InstancedFlow instance.

**count** |  The number of instanced elements.  
---|---  
**curveCount** |  The number of curves to preallocate for.  
**geometry** |  The geometry to use for the instanced mesh.  
**material** |  The material to use for the instanced mesh.  
...
**index** |  The index of the instanced element to update.  
---|---  
**curveNo** |  The index of the curve it should use.  
...
**index** |  The index of tge instanced element to update.  
---|---  
