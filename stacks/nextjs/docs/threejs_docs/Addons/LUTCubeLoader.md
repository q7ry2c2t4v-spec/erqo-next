...
> Source: https://threejs.org/docs/pages/LUTCubeLoader.html
> Category: Addons
...
### new LUTCubeLoader( manager : [LoadingManager](LoadingManager.html) )
...
**input** |  The raw Cube LUT data as a string.  
---|---  
...
### .setType( type : [UnsignedByteType](global.html#UnsignedByteType) | [FloatType](global.html#FloatType) ) : [LUTCubeLoader](LUTCubeLoader.html)
