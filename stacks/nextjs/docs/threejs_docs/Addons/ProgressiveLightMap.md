...
> Source: https://threejs.org/docs/pages/ProgressiveLightMap.html
> Category: Addons
...
### new ProgressiveLightMap( renderer : [WebGLRenderer](WebGLRenderer.html), res : number )
...
### .addObjectsToLightMap( objects : Array.<[Object3D](Object3D.html)> )
...
### .showDebugLightmap( visible : boolean, position : [Vector3](Vector3.html) )
...
### .update( camera : [Camera](Camera.html), blendWindow : number, blurEdges : boolean )
