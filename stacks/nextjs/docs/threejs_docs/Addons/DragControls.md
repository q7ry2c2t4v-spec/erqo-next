...
> Source: https://threejs.org/docs/pages/DragControls.html
> Category: Addons
...
### new DragControls( objects : Array.<[Object3D](Object3D.html)>, camera : [Camera](Camera.html), domElement : HTMLElement )
...
### .objects : Array.<[Object3D](Object3D.html)>
