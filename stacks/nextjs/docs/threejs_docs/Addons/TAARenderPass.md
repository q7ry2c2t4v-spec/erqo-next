...
> Source: https://threejs.org/docs/pages/TAARenderPass.html
> Category: Addons

[Pass](Pass.html) → [SSAARenderPass](SSAARenderPass.html) → 
...
### new TAARenderPass( scene : [Scene](Scene.html), camera : [Camera](Camera.html), clearColor : number | [Color](Color.html) | string, clearAlpha : number )
