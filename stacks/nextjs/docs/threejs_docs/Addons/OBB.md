...
> Source: https://threejs.org/docs/pages/OBB.html
> Category: Addons
...
### new OBB( center : [Vector3](Vector3.html), halfSize : [Vector3](Vector3.html), rotation : [Matrix3](Matrix3.html) )
...
### .halfSize : [Vector3](Vector3.html)

Positive halfwidth extents of the OBB along each axis.

### .rotation : [Matrix3](Matrix3.html)

The rotation of the OBB.

## Methods

### .applyMatrix4( matrix : [Matrix4](Matrix4.html) ) : [OBB](OBB.html)
...
### .copy( obb : [OBB](OBB.html) ) : [OBB](OBB.html)
...
### .equals( obb : [OBB](OBB.html) ) : boolean
...
### .fromBox3( box3 : [Box3](Box3.html) ) : [OBB](OBB.html)

Defines an OBB based on the given AABB.

**box3** |  The AABB to setup the OBB from.  
---|---  
...
### .intersectsBox3( box3 : [Box3](Box3.html) ) : boolean
...
### .intersectsOBB( obb : [OBB](OBB.html), epsilon : number ) : boolean

Returns `true` if the given OBB intersects this OBB.

**obb** |  The OBB to test.  
---|---  
**epsilon** |  A small value to prevent arithmetic errors. Default is `Number.EPSILON`.  
...
### .set( center : [Vector3](Vector3.html), halfSize : [Vector3](Vector3.html), rotation : [Matrix3](Matrix3.html) ) : [OBB](OBB.html)
