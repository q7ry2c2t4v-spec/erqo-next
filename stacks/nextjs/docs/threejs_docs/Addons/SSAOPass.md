...
> Source: https://threejs.org/docs/pages/SSAOPass.html
> Category: Addons
...
### new SSAOPass( scene : [Scene](Scene.html), camera : [Camera](Camera.html), width : number, height : number, kernelSize : number )
