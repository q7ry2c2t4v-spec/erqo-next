...
> Source: https://threejs.org/docs/pages/RoundedBoxGeometry.html
> Category: Addons

[EventDispatcher](EventDispatcher.html) → [BufferGeometry](BufferGeometry.html) → [BoxGeometry](BoxGeometry.html) → 
...
**segments** |  Number of segments that form the rounded corners. Default is `2`.  
**radius** |  The radius of the rounded corners. Default is `0.1`.  
...
### .fromJSON( data : Object ) : [RoundedBoxGeometry](RoundedBoxGeometry.html)
