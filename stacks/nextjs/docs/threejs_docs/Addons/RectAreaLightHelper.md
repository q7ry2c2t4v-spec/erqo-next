...
> Source: https://threejs.org/docs/pages/RectAreaLightHelper.html
> Category: Addons
...
### new RectAreaLightHelper( light : [RectAreaLight](RectAreaLight.html), color : number | [Color](Color.html) | string )
...
### .color : number | [Color](Color.html) | string | undefined

The helper's color. If `undefined`, the helper will take the color of the light.

### .light : [RectAreaLight](RectAreaLight.html)
