...
> Source: https://threejs.org/docs/pages/RapierPhysics.html
> Category: Addons
...
### .addHeightfield( mesh : [Mesh](Mesh.html), width : number, depth : number, heights : Float32Array, scale : Object ) : RigidBody
...
### .addMesh( mesh : [Mesh](Mesh.html), mass : number, restitution : number )
...
**restitution** |  The restitution of the mesh, usually from 0 to 1. Represents how "bouncy" objects are when they collide with each other. Default is `0`.  
  
### .addScene( scene : [Object3D](Object3D.html) )
...
### .removeMesh( mesh : [Mesh](Mesh.html) )
...
### .setMeshPosition( mesh : [Mesh](Mesh.html), position : [Vector3](Vector3.html), index : number )
...
### .setMeshVelocity( mesh : [Mesh](Mesh.html), velocity : [Vector3](Vector3.html), index : number )
