...
> Source: https://threejs.org/docs/pages/OutlineNode.html
> Category: Addons
...
### new OutlineNode( scene : [Scene](Scene.html), camera : [Camera](Camera.html), params : Object )
...
### .edgeGlowNode : [Node](Node.html).<float>

Can be used for an animated glow/pulse effect.

### .edgeThicknessNode : [Node](Node.html).<float>
