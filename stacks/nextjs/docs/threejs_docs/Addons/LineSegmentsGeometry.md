...
> Source: https://threejs.org/docs/pages/LineSegmentsGeometry.html
> Category: Addons
...
### .applyMatrix4( matrix : [Matrix4](Matrix4.html) ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .fromEdgesGeometry( geometry : [EdgesGeometry](EdgesGeometry.html) ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .fromLineSegments( lineSegments : [LineSegments](LineSegments.html) ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .fromMesh( mesh : [Mesh](Mesh.html) ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .fromWireframeGeometry( geometry : [WireframeGeometry](WireframeGeometry.html) ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .setColors( array : Float32Array | Array.<number> ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
...
### .setPositions( array : Float32Array | Array.<number> ) : [LineSegmentsGeometry](LineSegmentsGeometry.html)
