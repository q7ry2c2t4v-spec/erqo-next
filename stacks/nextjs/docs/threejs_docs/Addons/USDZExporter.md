...
> Source: https://threejs.org/docs/pages/USDZExporter.html
> Category: Addons
...
### .parse( scene : [Object3D](Object3D.html), onDone : [USDZExporter~OnDone](USDZExporter.html#~OnDone), onError : [USDZExporter~OnError](USDZExporter.html#~OnError), options : [USDZExporter~Options](USDZExporter.html#~Options) )
...
### .parseAsync( scene : [Object3D](Object3D.html), options : [USDZExporter~Options](USDZExporter.html#~Options) ) : Promise.<ArrayBuffer> (async) 
...
### .setTextureUtils( utils : [WebGLTextureUtils](WebGLTextureUtils.html) | [WebGPUTextureUtils](WebGPUTextureUtils.html) )
