...
> Source: https://threejs.org/docs/pages/Rhino3dmLoader.html
> Category: Addons
...
### new Rhino3dmLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .decodeObjects( buffer : ArrayBuffer, url : string ) : Promise.<[Object3D](Object3D.html)>
...
### .parse( data : ArrayBuffer, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )
...
### .setLibraryPath( path : string ) : [Rhino3dmLoader](Rhino3dmLoader.html)
...
### .setWorkerLimit( workerLimit : number ) : [Rhino3dmLoader](Rhino3dmLoader.html)
