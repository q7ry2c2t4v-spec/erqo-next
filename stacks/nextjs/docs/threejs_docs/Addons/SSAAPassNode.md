...
> Source: https://threejs.org/docs/pages/SSAAPassNode.html
> Category: Addons
...
### new SSAAPassNode( scene : [Scene](Scene.html), camera : [Camera](Camera.html) )
...
### .sampleWeight : [UniformNode](UniformNode.html).<float>
