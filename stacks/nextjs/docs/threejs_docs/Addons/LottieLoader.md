...
> Source: https://threejs.org/docs/pages/LottieLoader.html
> Category: Addons
...
### new LottieLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [CanvasTexture](CanvasTexture.html)
