...
> Source: https://threejs.org/docs/pages/TeapotGeometry.html
> Category: Addons
...
Segments 'n' determines the number of triangles output. Total triangles = 32 _2_ n _n - 8_ n (degenerates at the top and bottom cusps are deleted).
