...
> Source: https://threejs.org/docs/pages/MarchingCubes.html
> Category: Addons
...
### new MarchingCubes( resolution : number, material : [Material](Material.html), enableUvs : boolean, enableColors : boolean, maxPolyCount : number )
...
### .addBall( ballx : number, bally : number, ballz : number, strength : number, subtract : number, colors : [Color](Color.html) )
