...
> Source: https://threejs.org/docs/pages/LineGeometry.html
> Category: Addons
...
### .fromLine( line : [Line](Line.html) ) : [LineGeometry](LineGeometry.html)
...
### .setColors( array : Float32Array | Array.<number> ) : [LineGeometry](LineGeometry.html)
...
### .setFromPoints( points : Array.<([Vector3](Vector3.html)|[Vector2](Vector2.html))> ) : [LineGeometry](LineGeometry.html)
...
### .setPositions( array : Float32Array | Array.<number> ) : [LineGeometry](LineGeometry.html)
