...
> Source: https://threejs.org/docs/pages/LDrawLoader.html
> Category: Addons
...
### new LDrawLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .addDefaultMaterials() : [LDrawLoader](LDrawLoader.html)

Initializes the loader with default materials.

**Returns:** A reference to this loader.

### .addMaterial( material : [Material](Material.html) ) : [LDrawLoader](LDrawLoader.html)
...
### .addMaterials( materials : Array.<[Material](Material.html)> ) : [LDrawLoader](LDrawLoader.html)
...
### .getMaterial( colorCode : string ) : [Material](Material.html)
...
### .parse( text : string, onLoad : function, onError : [onErrorCallback](global.html#onErrorCallback) )

Parses the given LDraw data and returns the resulting group.

**text** |  The raw VRML data as a string.  
---|---  
...
**url** |  Path of the LDraw materials asset.  
---|---  
  
**Returns:** A Promise that resolves when the preload has finished.

### .setConditionalLineMaterial( type : LDrawConditionalLineMaterial.constructor | LDrawConditionalLineNodeMaterial.constructor ) : [LDrawLoader](LDrawLoader.html)
...
**type** |  The conditional line material type.  
---|---  
  
**Returns:** A reference to this loader.

### .setFileMap( fileMap : Object.<string, string> ) : [LDrawLoader](LDrawLoader.html)
...
**fileMap** |  The file map to set.  
---|---  
  
**Returns:** A reference to this loader.

### .setMaterials( materials : Array.<[Material](Material.html)> ) : [LDrawLoader](LDrawLoader.html)

Sets the loader's material library. This method clears existing material definitions.

**materials** |  The materials to set.  
---|---  
  
**Returns:** A reference to this loader.

### .setPartsLibraryPath( path : string ) : [LDrawLoader](LDrawLoader.html)
