...
> Source: https://threejs.org/docs/pages/LineSegments2.html
> Category: Addons
...
### new LineSegments2( geometry : [LineSegmentsGeometry](LineSegmentsGeometry.html), material : [LineMaterial](LineMaterial.html) )
