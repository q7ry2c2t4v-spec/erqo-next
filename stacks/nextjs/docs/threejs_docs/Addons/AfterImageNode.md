...
> Source: https://threejs.org/docs/pages/AfterImageNode.html
> Category: Addons
...
### new AfterImageNode( textureNode : [TextureNode](TextureNode.html), damp : [Node](Node.html).<float> )
