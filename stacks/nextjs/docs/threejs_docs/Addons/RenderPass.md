...
> Source: https://threejs.org/docs/pages/RenderPass.html
> Category: Addons
...
### new RenderPass( scene : [Scene](Scene.html), camera : [Camera](Camera.html), overrideMaterial : [Material](Material.html), clearColor : number | [Color](Color.html) | string, clearAlpha : number )
...
---|---  
**camera** |  The camera.  
**overrideMaterial** |  The override material. If set, this material is used for all objects in the scene. Default is `null`.  
**clearColor** |  The clear color of the render pass. Default is `null`.  
**clearAlpha** |  The clear alpha of the render pass. Default is `null`.  
...
### .overrideMaterial : [Material](Material.html)
