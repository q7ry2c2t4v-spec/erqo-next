...
> Source: https://threejs.org/docs/pages/CSMFrustum.html
> Category: Addons
...
### new CSMFrustum( data : [CSMFrustum~Data](CSMFrustum.html#~Data) )
...
### .setFromProjectionMatrix( projectionMatrix : [Matrix4](Matrix4.html), maxFar : number ) : Object
...
### .split( breaks : Array.<number>, target : Array.<[CSMFrustum](CSMFrustum.html)> )
...
### .toSpace( cameraMatrix : [Matrix4](Matrix4.html), target : [CSMFrustum](CSMFrustum.html) )
...
---|---  
**projectionMatrix**   
[Matrix4](Matrix4.html) |  A projection matrix usually of the scene's camera.  
**maxFar**   
