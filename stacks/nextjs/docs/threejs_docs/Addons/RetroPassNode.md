...
> Source: https://threejs.org/docs/pages/RetroPassNode.html
> Category: Addons
...
### new RetroPassNode( scene : [Scene](Scene.html), camera : [Camera](Camera.html), options : Object )
...
**options** |  Additional options for the retro pass. Default is `{}`. |  **affineDistortion** |  An optional node to apply affine distortion to UVs. Default is `null`.  
---|---  
