...
> Source: https://threejs.org/docs/pages/OutlinePass.html
> Category: Addons
...
### new OutlinePass( resolution : [Vector2](Vector2.html), scene : [Scene](Scene.html), camera : [Camera](Camera.html), selectedObjects : Array.<[Object3D](Object3D.html)> )
...
**camera** |  The camera.  
**selectedObjects** |  The selected 3D objects that should receive an outline.  
...
### .hiddenEdgeColor : [Color](Color.html)

The hidden edge color.

Default is `(0.1,0.04,0.02)`.

### .patternTexture : [Texture](Texture.html)
...
### .resolution : [Vector2](Vector2.html)

The effect's resolution.

Default is `(256,256)`.

### .selectedObjects : Array.<[Object3D](Object3D.html)>
...
### .visibleEdgeColor : [Color](Color.html)
