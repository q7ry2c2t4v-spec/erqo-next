...
> Source: https://threejs.org/docs/pages/AnamorphicNode.html
> Category: Addons
...
### new AnamorphicNode( textureNode : [TextureNode](TextureNode.html), thresholdNode : [Node](Node.html).<float>, scaleNode : [Node](Node.html).<float>, samples : number )
