...
> Source: https://threejs.org/docs/pages/PositionalAudioHelper.html
> Category: Addons
...
### new PositionalAudioHelper( audio : [PositionalAudio](PositionalAudio.html), range : number, divisionsInnerAngle : number, divisionsOuterAngle : number )
...
### .audio : [PositionalAudio](PositionalAudio.html)
