...
> Source: https://threejs.org/docs/pages/ThreeMFLoader.html
> Category: Addons
...
### new ThreeMFLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( data : ArrayBuffer ) : [Group](Group.html)
