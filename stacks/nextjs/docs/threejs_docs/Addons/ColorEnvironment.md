...
> Source: https://threejs.org/docs/pages/ColorEnvironment.html
> Category: Addons
...
### new ColorEnvironment( color : number | [Color](Color.html) )

Constructs a new color environment.

**color** |  The color of the environment. Default is `16777215`.  
---|---  
