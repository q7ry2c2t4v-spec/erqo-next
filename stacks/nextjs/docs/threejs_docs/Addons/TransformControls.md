...
### new TransformControls( camera : [Camera](Camera.html), domElement : HTMLElement )
...
### .attach( object : [Object3D](Object3D.html) ) : [TransformControls](TransformControls.html)
...
### .detach() : [TransformControls](TransformControls.html)
...
### .getRaycaster() : [Raycaster](Raycaster.html)
...
### .setColors( xAxis : number | [Color](Color.html) | string, yAxis : number | [Color](Color.html) | string, zAxis : number | [Color](Color.html) | string, active : number | [Color](Color.html) | string )
