...
> Source: https://threejs.org/docs/pages/MD2CharacterComplex.html
> Category: Addons
...
### .currentSkin : [Texture](Texture.html)
...
### .meshBody : [Mesh](Mesh.html)

The body mesh.

Default is `null`.

### .meshWeapon : [Mesh](Mesh.html)
...
### .skinsBody : Array.<[Texture](Texture.html)>

The body skins.

### .skinsWeapon : Array.<[Texture](Texture.html)>
...
### .shareParts( original : [MD2CharacterComplex](MD2CharacterComplex.html) )
