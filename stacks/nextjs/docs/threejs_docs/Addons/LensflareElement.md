...
> Source: https://threejs.org/docs/pages/LensflareElement.html
> Category: Addons
...
### new LensflareElement( texture : [Texture](Texture.html), size : number, distance : number, color : [Color](Color.html) )
