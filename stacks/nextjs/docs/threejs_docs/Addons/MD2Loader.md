...
> Source: https://threejs.org/docs/pages/MD2Loader.html
> Category: Addons
...
### new MD2Loader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( buffer : ArrayBuffer ) : [BufferGeometry](BufferGeometry.html)
