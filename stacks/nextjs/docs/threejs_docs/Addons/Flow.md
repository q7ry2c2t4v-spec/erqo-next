...
> Source: https://threejs.org/docs/pages/Flow.html
> Category: Addons
...
### new Flow( mesh : [Mesh](Mesh.html), numberOfCurves : number )

Constructs a new Flow instance.

**mesh** |  The mesh to clone and modify to bend around the curve.  
---|---  
**numberOfCurves** |  The amount of space that should preallocated for additional curves. Default is `1`.  
...
### .updateCurve( index : number, curve : [Curve](Curve.html) )

Updates the curve for the given curve index.

**index** |  The curve index.  
---|---  
**curve** |  The curve that should be used to bend the mesh.  
