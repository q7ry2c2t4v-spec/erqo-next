...
> Source: https://threejs.org/docs/pages/FBXLoader.html
> Category: Addons
...
### new FBXLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .parse( FBXBuffer : ArrayBuffer, path : string ) : [Group](Group.html)
