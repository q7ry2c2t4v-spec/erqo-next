...
> Source: https://threejs.org/docs/pages/XRControllerModel.html
> Category: Addons
...
### .setEnvironmentMap( envMap : [Texture](Texture.html) ) : [XRControllerModel](XRControllerModel.html)

Sets an environment map that is applied to the controller model.

**envMap** |  The environment map to apply.  
---|---  
