...
> Source: https://threejs.org/docs/pages/PhysicalLightingModel.html
> Category: Core
...
**clearcoat** |  Whether clearcoat is supported or not. Default is `false`.  
---|---  
**sheen** |  Whether sheen is supported or not. Default is `false`.  
**iridescence** |  Whether iridescence is supported or not. Default is `false`.  
**anisotropy** |  Whether anisotropy is supported or not. Default is `false`.  
**transmission** |  Whether transmission is supported or not. Default is `false`.  
**dispersion** |  Whether dispersion is supported or not. Default is `false`.  
...
### .clearcoatRadiance : [Node](Node.html)

The clear coat radiance.

Default is `null`.

### .clearcoatSpecularDirect : [Node](Node.html)

The clear coat specular direct.

Default is `null`.

### .clearcoatSpecularIndirect : [Node](Node.html)
...
### .iridescenceF0 : [Node](Node.html)

The iridescence F0.

Default is `null`.

### .iridescenceF0Dielectric : [Node](Node.html)

The iridescence F0 dielectric.

Default is `null`.

### .iridescenceF0Metallic : [Node](Node.html)

The iridescence F0 metallic.

Default is `null`.

### .iridescenceFresnel : [Node](Node.html)
...
### .sheenSpecularDirect : [Node](Node.html)

The sheen specular direct.

Default is `null`.

### .sheenSpecularIndirect : [Node](Node.html)
...
### .ambientOcclusion( builder : [NodeBuilder](NodeBuilder.html) )
...
### .directRectArea( input : Object, builder : [NodeBuilder](NodeBuilder.html) )
...
### .finish( builder : [NodeBuilder](NodeBuilder.html) )
...
### .indirectDiffuse( builder : [NodeBuilder](NodeBuilder.html) )
...
### .indirectSpecular( builder : [NodeBuilder](NodeBuilder.html) )
...
### .start( builder : [NodeBuilder](NodeBuilder.html) )
