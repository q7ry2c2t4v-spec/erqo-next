...
> Source: https://threejs.org/docs/pages/Loader.html
> Category: Core
...
### new Loader( manager : [LoadingManager](LoadingManager.html) ) (abstract) 
...
### .manager : [LoadingManager](LoadingManager.html)
...
### .requestHeader : Object.<string, [any](global.html#any)>
...
### .abort() : [Loader](Loader.html) (abstract) 

This method can be implemented in loaders for aborting ongoing requests.

**Returns:** A reference to this instance.

### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) (abstract) 
...
### .loadAsync( url : string, onProgress : [onProgressCallback](global.html#onProgressCallback) ) : Promise
...
### .parse( data : [any](global.html#any) ) (abstract) 
...
### .setCrossOrigin( crossOrigin : string ) : [Loader](Loader.html)

Sets the `crossOrigin` String to implement CORS for loading the URL from a different domain that allows CORS.

**crossOrigin** |  The `crossOrigin` value.  
---|---  
  
**Returns:** A reference to this instance.

### .setPath( path : string ) : [Loader](Loader.html)
...
### .setRequestHeader( requestHeader : Object ) : [Loader](Loader.html)

Sets the given request header.

**requestHeader** |  A [request header](https://developer.mozilla.org/en-US/docs/Glossary/Request_header) for configuring the HTTP request.  
---|---  
  
**Returns:** A reference to this instance.

### .setResourcePath( resourcePath : string ) : [Loader](Loader.html)
...
### .setWithCredentials( value : boolean ) : [Loader](Loader.html)
...
**value** |  The `withCredentials` value.  
---|---  
