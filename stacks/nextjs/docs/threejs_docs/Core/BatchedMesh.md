...
### new BatchedMesh( maxInstanceCount : number, maxVertexCount : number, maxIndexCount : number, material : [Material](Material.html) | Array.<[Material](Material.html)> )
...
### .addGeometry( geometry : [BufferGeometry](BufferGeometry.html), reservedVertexCount : number, reservedIndexCount : number ) : number
...
**geometryId** |  The ID of a previously added geometry via [BatchedMesh#addGeometry](BatchedMesh.html#addGeometry).  
---|---  
...
### .deleteGeometry( geometryId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .deleteInstance( instanceId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .getBoundingBoxAt( geometryId : number, target : [Box3](Box3.html) ) : [Box3](Box3.html)
...
### .getBoundingSphereAt( geometryId : number, target : [Sphere](Sphere.html) ) : [Sphere](Sphere.html)
...
### .getColorAt( instanceId : number, color : [Color](Color.html) | [Vector4](Vector4.html) ) : [Color](Color.html) | [Vector4](Vector4.html)
...
### .getMatrixAt( instanceId : number, matrix : [Matrix4](Matrix4.html) ) : [Matrix4](Matrix4.html)
...
### .optimize() : [BatchedMesh](BatchedMesh.html)
...
### .setColorAt( instanceId : number, color : [Color](Color.html) | [Vector4](Vector4.html) ) : [BatchedMesh](BatchedMesh.html)

Sets the given color to the defined instance.

**instanceId** |  The ID of an instance to set the color of.  
---|---  
**color** |  The color to set the instance to. Use a `Vector4` to also define alpha.  
  
**Returns:** A reference to this batched mesh.

### .setCustomSort( func : function ) : [BatchedMesh](BatchedMesh.html)
...
### .setGeometryAt( geometryId : number, geometry : [BufferGeometry](BufferGeometry.html) ) : number
...
### .setGeometryIdAt( instanceId : number, geometryId : number ) : [BatchedMesh](BatchedMesh.html)
...
### .setMatrixAt( instanceId : number, matrix : [Matrix4](Matrix4.html) ) : [BatchedMesh](BatchedMesh.html)
...
### .setVisibleAt( instanceId : number, visible : boolean ) : [BatchedMesh](BatchedMesh.html)
