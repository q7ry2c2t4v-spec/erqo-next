...
> Source: https://threejs.org/docs/pages/SkinnedMesh.html
> Category: Core
...
### new SkinnedMesh( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)> )
...
### .bindMatrix : [Matrix4](Matrix4.html)

The base matrix that is used for the bound bone transforms.

### .bindMatrixInverse : [Matrix4](Matrix4.html)

The base matrix that is used for resetting the bound bone transforms.

### .bindMode : [AttachedBindMode](global.html#AttachedBindMode) | [DetachedBindMode](global.html#DetachedBindMode)
...
### .applyBoneTransform( index : number, target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)

Applies the bone transform associated with the given index to the given vertex position. Returns the updated vector.

**index** |  The vertex index.  
---|---  
**target** |  The target object that is used to store the method's result. the skinned mesh's world matrix will be used instead.  
  
**Returns:** The updated vertex position.

### .bind( skeleton : [Skeleton](Skeleton.html), bindMatrix : [Matrix4](Matrix4.html) )

Binds the given skeleton to the skinned mesh.

**skeleton** |  The skeleton to bind.  
---|---  
**bindMatrix** |  The bind matrix. If no bind matrix is provided, the skinned mesh's world matrix will be used instead.  
