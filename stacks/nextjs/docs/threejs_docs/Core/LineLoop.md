...
> Source: https://threejs.org/docs/pages/LineLoop.html
> Category: Core
...
### new LineLoop( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)> )
