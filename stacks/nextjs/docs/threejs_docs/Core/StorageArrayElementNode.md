...
> Source: https://threejs.org/docs/pages/StorageArrayElementNode.html
> Category: Core
...
### new StorageArrayElementNode( storageBufferNode : [StorageBufferNode](StorageBufferNode.html), indexNode : [Node](Node.html) )
...
### .storageBufferNode : [StorageBufferNode](StorageBufferNode.html)
