...
> Source: https://threejs.org/docs/pages/LOD.html
> Category: Core
...
### .addLevel( object : [Object3D](Object3D.html), distance : number, hysteresis : number ) : [LOD](LOD.html)

Adds a mesh that will display at a certain distance and greater. Typically the further away the distance, the lower the detail on the mesh.

**object** |  The 3D object to display at this level.  
---|---  
**distance** |  The distance at which to display this level of detail. Default is `0`.  
**hysteresis** |  Threshold used to avoid flickering at LOD boundaries, as a fraction of distance. Default is `0`.  
...
### .getObjectForDistance( distance : number ) : [Object3D](Object3D.html)

Returns a reference to the first 3D object that is greater than the given distance.

**distance** |  The LOD distance.  
---|---  
...
**distance** |  Distance of the level to remove.  
---|---  
  
**Returns:** Whether the level has been removed or not.

### .update( camera : [Camera](Camera.html) )
