...
> Source: https://threejs.org/docs/pages/AnimationAction.html
> Category: Core
...
### new AnimationAction( mixer : [AnimationMixer](AnimationMixer.html), clip : [AnimationClip](AnimationClip.html), localRoot : [Object3D](Object3D.html), blendMode : [NormalAnimationBlendMode](global.html#NormalAnimationBlendMode) | [AdditiveAnimationBlendMode](global.html#AdditiveAnimationBlendMode) )
...
### .blendMode : [NormalAnimationBlendMode](global.html#NormalAnimationBlendMode) | [AdditiveAnimationBlendMode](global.html#AdditiveAnimationBlendMode)
...
### .loop : [LoopRepeat](global.html#LoopRepeat) | [LoopOnce](global.html#LoopOnce) | [LoopPingPong](global.html#LoopPingPong)
...
### .crossFadeFrom( fadeOutAction : [AnimationAction](AnimationAction.html), duration : number, warp : boolean ) : [AnimationAction](AnimationAction.html)
...
### .crossFadeTo( fadeInAction : [AnimationAction](AnimationAction.html), duration : number, warp : boolean ) : [AnimationAction](AnimationAction.html)
...
### .fadeIn( duration : number ) : [AnimationAction](AnimationAction.html)
...
### .fadeOut( duration : number ) : [AnimationAction](AnimationAction.html)
...
### .getClip() : [AnimationClip](AnimationClip.html)
...
### .getMixer() : [AnimationMixer](AnimationMixer.html)

Returns the animation mixer of this animation action.

**Returns:** The animation mixer.

### .getRoot() : [Object3D](Object3D.html)

Returns the root object of this animation action.

**Returns:** The root object.

### .halt( duration : number ) : [AnimationAction](AnimationAction.html)
...
### .play() : [AnimationAction](AnimationAction.html)

Starts the playback of the animation.

**Returns:** A reference to this animation action.

### .reset() : [AnimationAction](AnimationAction.html)

Resets the playback of the animation.

**Returns:** A reference to this animation action.

### .setDuration( duration : number ) : [AnimationAction](AnimationAction.html)
...
### .setEffectiveTimeScale( timeScale : number ) : [AnimationAction](AnimationAction.html)
...
### .setEffectiveWeight( weight : number ) : [AnimationAction](AnimationAction.html)
...
### .setLoop( mode : [LoopRepeat](global.html#LoopRepeat) | [LoopOnce](global.html#LoopOnce) | [LoopPingPong](global.html#LoopPingPong), repetitions : number ) : [AnimationAction](AnimationAction.html)
...
### .startAt( time : number ) : [AnimationAction](AnimationAction.html)
...
### .stop() : [AnimationAction](AnimationAction.html)

Stops the playback of the animation.

**Returns:** A reference to this animation action.

### .stopFading() : [AnimationAction](AnimationAction.html)

Stops any fading which is applied to this action.

**Returns:** A reference to this animation action.

### .stopWarping() : [AnimationAction](AnimationAction.html)

Stops any scheduled warping which is applied to this action.

**Returns:** A reference to this animation action.

### .syncWith( action : [AnimationAction](AnimationAction.html) ) : [AnimationAction](AnimationAction.html)
...
### .warp( startTimeScale : number, endTimeScale : number, duration : number ) : [AnimationAction](AnimationAction.html)
