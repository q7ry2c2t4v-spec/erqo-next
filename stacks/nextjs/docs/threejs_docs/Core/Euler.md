...
> Source: https://threejs.org/docs/pages/Euler.html
> Category: Core
...
### .clone() : [Euler](Euler.html)

Returns a new Euler instance with copied values from this instance.

**Returns:** A clone of this instance.

### .copy( euler : [Euler](Euler.html) ) : [Euler](Euler.html)
...
### .equals( euler : [Euler](Euler.html) ) : boolean
...
### .fromArray( array : Array.<number, number, number, ?string> ) : [Euler](Euler.html)
...
### .reorder( newOrder : string ) : [Euler](Euler.html)
...
### .set( x : number, y : number, z : number, order : string ) : [Euler](Euler.html)
...
### .setFromQuaternion( q : [Quaternion](Quaternion.html), order : string, update : boolean ) : [Euler](Euler.html)
...
### .setFromRotationMatrix( m : [Matrix4](Matrix4.html), order : string, update : boolean ) : [Euler](Euler.html)
...
### .setFromVector3( v : [Vector3](Vector3.html), order : string ) : [Euler](Euler.html)
