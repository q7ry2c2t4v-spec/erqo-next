...
> Source: https://threejs.org/docs/pages/PropertyBinding.html
> Category: Core
...
### .rootNode : [Object3D](Object3D.html) | [Skeleton](Skeleton.html)
...
### .create( root : Object, path : string, parsedPath : Object ) : [PropertyBinding](PropertyBinding.html) | Composite
