...
> Source: https://threejs.org/docs/pages/Vector4.html
> Category: Core
...
### .add( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .addScalar( s : number ) : [Vector4](Vector4.html)
...
### .addScaledVector( v : [Vector4](Vector4.html), s : number ) : [Vector4](Vector4.html)
...
### .addVectors( a : [Vector4](Vector4.html), b : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .applyMatrix4( m : [Matrix4](Matrix4.html) ) : [Vector4](Vector4.html)
...
### .ceil() : [Vector4](Vector4.html)

The components of this vector are rounded up to the nearest integer value.

**Returns:** A reference to this vector.

### .clamp( min : [Vector4](Vector4.html), max : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .clampLength( min : number, max : number ) : [Vector4](Vector4.html)
...
### .clampScalar( minVal : number, maxVal : number ) : [Vector4](Vector4.html)
...
### .copy( v : [Vector3](Vector3.html) | [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .divide( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .divideScalar( scalar : number ) : [Vector4](Vector4.html)
...
### .dot( v : [Vector4](Vector4.html) ) : number
...
### .equals( v : [Vector4](Vector4.html) ) : boolean
...
### .floor() : [Vector4](Vector4.html)

The components of this vector are rounded down to the nearest integer value.

**Returns:** A reference to this vector.

### .fromArray( array : Array.<number>, offset : number ) : [Vector4](Vector4.html)
...
### .fromBufferAttribute( attribute : [BufferAttribute](BufferAttribute.html), index : number ) : [Vector4](Vector4.html)
...
**index** |  The component index. `0` equals to x, `1` equals to y, `2` equals to z, `3` equals to w.  
---|---  
...
### .lerp( v : [Vector4](Vector4.html), alpha : number ) : [Vector4](Vector4.html)
...
### .lerpVectors( v1 : [Vector4](Vector4.html), v2 : [Vector4](Vector4.html), alpha : number ) : [Vector4](Vector4.html)
...
### .max( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .min( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .multiply( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .multiplyScalar( scalar : number ) : [Vector4](Vector4.html)
...
### .normalize() : [Vector4](Vector4.html)
...
### .random() : [Vector4](Vector4.html)

Sets each component of this vector to a pseudo-random value between `0` and `1`, excluding `1`.

**Returns:** A reference to this vector.

### .round() : [Vector4](Vector4.html)

The components of this vector are rounded to the nearest integer value

**Returns:** A reference to this vector.

### .roundToZero() : [Vector4](Vector4.html)

The components of this vector are rounded towards zero (up if negative, down if positive) to an integer value.

**Returns:** A reference to this vector.

### .set( x : number, y : number, z : number, w : number ) : [Vector4](Vector4.html)
...
### .setAxisAngleFromQuaternion( q : [Quaternion](Quaternion.html) ) : [Vector4](Vector4.html)
...
### .setAxisAngleFromRotationMatrix( m : [Matrix4](Matrix4.html) ) : [Vector4](Vector4.html)

Sets the x, y and z components of this vector to the axis of rotation and w to the angle.

**m** |  A 4x4 matrix of which the upper left 3x3 matrix is a pure rotation matrix.  
---|---  
  
**Returns:** A reference to this vector.

### .setComponent( index : number, value : number ) : [Vector4](Vector4.html)
...
### .setFromMatrixPosition( m : [Matrix4](Matrix4.html) ) : [Vector4](Vector4.html)
...
### .setLength( length : number ) : [Vector4](Vector4.html)
...
### .setScalar( scalar : number ) : [Vector4](Vector4.html)
...
### .setW( w : number ) : [Vector4](Vector4.html)
...
### .setX( x : number ) : [Vector4](Vector4.html)
...
### .setY( y : number ) : [Vector4](Vector4.html)
...
### .setZ( z : number ) : [Vector4](Vector4.html)
...
### .sub( v : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
...
### .subScalar( s : number ) : [Vector4](Vector4.html)
...
### .subVectors( a : [Vector4](Vector4.html), b : [Vector4](Vector4.html) ) : [Vector4](Vector4.html)
