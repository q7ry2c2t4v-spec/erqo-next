...
> Source: https://threejs.org/docs/pages/DirectionalLightHelper.html
> Category: Core
...
### new DirectionalLightHelper( light : [DirectionalLight](DirectionalLight.html), size : number, color : number | [Color](Color.html) | string )
...
### .light : [DirectionalLight](DirectionalLight.html)

The light being visualized.

### .lightPlane : [Line](Line.html)

Contains the line showing the location of the directional light.

### .targetLine : [Line](Line.html)
