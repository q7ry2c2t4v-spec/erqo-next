...
> Source: https://threejs.org/docs/pages/PassMultipleTextureNode.html
> Category: Core
...
### new PassMultipleTextureNode( passNode : [PassNode](PassNode.html), textureName : string, previousTexture : boolean )
