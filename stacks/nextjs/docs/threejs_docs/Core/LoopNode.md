...
> Source: https://threejs.org/docs/pages/LoopNode.html
> Category: Core
...
### new LoopNode( params : Array.<[any](global.html#any)> )

Constructs a new loop node.

**params** |  Depending on the loop type, array holds different parameterization values for the loop.  
---|---  
  
## Methods

### .getProperties( builder : [NodeBuilder](NodeBuilder.html) ) : Object
