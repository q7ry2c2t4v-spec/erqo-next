...
> Source: https://threejs.org/docs/pages/GridHelper.html
> Category: Core
...
### new GridHelper( size : number, divisions : number, color1 : number | [Color](Color.html) | string, color2 : number | [Color](Color.html) | string )
...
**color1** |  The color of the center line. Default is `0x444444`.  
**color2** |  The color of the lines of the grid. Default is `0x888888`.  
