...
> Source: https://threejs.org/docs/pages/Skeleton.html
> Category: Core
...
### new Skeleton( bones : Array.<[Bone](Bone.html)>, boneInverses : Array.<[Matrix4](Matrix4.html)> )

Constructs a new skeleton.

**bones** |  An array of bones.  
---|---  
**boneInverses** |  An array of bone inverse matrices. If not provided, these matrices will be computed automatically via [Skeleton#calculateInverses](Skeleton.html#calculateInverses).  
  
## Properties

### .boneInverses : Array.<[Matrix4](Matrix4.html)>
...
### .boneTexture : [DataTexture](DataTexture.html)
...
### .clone() : [Skeleton](Skeleton.html)

Returns a new skeleton with copied values from this instance.

**Returns:** A clone of this instance.

### .computeBoneTexture() : [Skeleton](Skeleton.html)
...
### .fromJSON( json : Object, bones : Object.<string, [Bone](Bone.html)> ) : [Skeleton](Skeleton.html)
...
### .getBoneByName( name : string ) : [Bone](Bone.html) | undefined
