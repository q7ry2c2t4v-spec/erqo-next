...
> Source: https://threejs.org/docs/pages/NodeFrame.html
> Category: Core
...
### .updateAfterMap : WeakMap.<[Node](Node.html), Object>

Used to control the [Node#updateAfter](Node.html#updateAfter) call.

### .updateBeforeMap : WeakMap.<[Node](Node.html), Object>

Used to control the [Node#updateBefore](Node.html#updateBefore) call.

### .updateMap : WeakMap.<[Node](Node.html), Object>
...
### .updateAfterNode( node : [Node](Node.html) )
...
### .updateBeforeNode( node : [Node](Node.html) )
...
### .updateNode( node : [Node](Node.html) )
