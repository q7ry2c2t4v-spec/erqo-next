...
> Source: https://threejs.org/docs/pages/ShapeGeometry.html
> Category: Core
...
### new ShapeGeometry( shapes : [Shape](Shape.html) | Array.<[Shape](Shape.html)>, curveSegments : number )
...
### .fromJSON( data : Object, shapes : Array.<[Shape](Shape.html)> ) : [ShapeGeometry](ShapeGeometry.html)
