...
> Source: https://threejs.org/docs/pages/CubicBezierCurve.html
> Category: Core
...
### new CubicBezierCurve( v0 : [Vector2](Vector2.html), v1 : [Vector2](Vector2.html), v2 : [Vector2](Vector2.html), v3 : [Vector2](Vector2.html) )
...
### .v0 : [Vector2](Vector2.html)

The start point.

### .v1 : [Vector2](Vector2.html)
...
### .v3 : [Vector2](Vector2.html)

The end point.

## Methods

### .getPoint( t : number, optionalTarget : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
