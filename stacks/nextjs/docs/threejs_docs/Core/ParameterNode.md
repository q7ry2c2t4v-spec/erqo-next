...
> Source: https://threejs.org/docs/pages/ParameterNode.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Node](Node.html) → [PropertyNode](PropertyNode.html) → 
...
---|---  
**name** |  The name of the parameter in the shader. Default is `null`.  
