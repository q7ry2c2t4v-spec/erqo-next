...
> Source: https://threejs.org/docs/pages/ViewportDepthNode.html
> Category: Core
...
### new ViewportDepthNode( scope : 'depth' | 'depthBase' | 'linearDepth', valueNode : [Node](Node.html) )

Constructs a new viewport depth node.

**scope** |  The node's scope.  
---|---  
**valueNode** |  The value node. Default is `null`.  
