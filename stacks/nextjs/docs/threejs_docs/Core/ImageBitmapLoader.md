...
> Source: https://threejs.org/docs/pages/ImageBitmapLoader.html
> Category: Core
...
### new ImageBitmapLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .abort() : [ImageBitmapLoader](ImageBitmapLoader.html)
...
### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : ImageBitmap | undefined
...
### .setOptions( options : Object ) : [ImageBitmapLoader](ImageBitmapLoader.html)
