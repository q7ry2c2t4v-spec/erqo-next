...
> Source: https://threejs.org/docs/pages/HemisphereLightHelper.html
> Category: Core
...
### new HemisphereLightHelper( light : [HemisphereLight](HemisphereLight.html), size : number, color : number | [Color](Color.html) | string )

Constructs a new hemisphere light helper.

**light** |  The light to be visualized.  
---|---  
**size** |  The size of the mesh used to visualize the light. Default is `1`.  
...
### .light : [HemisphereLight](HemisphereLight.html)
