...
> Source: https://threejs.org/docs/pages/InterleavedBuffer.html
> Category: Core
...
**array** |  A typed array with a shared buffer storing attribute data.  
---|---  
...
### .clone( data : Object ) : [InterleavedBuffer](InterleavedBuffer.html)

Returns a new interleaved buffer with copied values from this instance.

**data** |  An object with shared array buffers that allows to retain shared structures.  
---|---  
  
**Returns:** A clone of this instance.

### .copy( source : [InterleavedBuffer](InterleavedBuffer.html) ) : [InterleavedBuffer](InterleavedBuffer.html)

Copies the values of the given interleaved buffer to this instance.

**source** |  The interleaved buffer to copy.  
---|---  
  
**Returns:** A reference to this instance.

### .copyAt( index1 : number, interleavedBuffer : [InterleavedBuffer](InterleavedBuffer.html), index2 : number ) : [InterleavedBuffer](InterleavedBuffer.html)
...
**index1** |  The destination index into this interleaved buffer.  
---|---  
**interleavedBuffer** |  The interleaved buffer to copy from.  
**index2** |  The source index into the given interleaved buffer.  
  
**Returns:** A reference to this instance.

### .onUpload( callback : function ) : [InterleavedBuffer](InterleavedBuffer.html)
...
### .set( value : TypedArray | Array, offset : number ) : [InterleavedBuffer](InterleavedBuffer.html)

Sets the given array data in the interleaved buffer.

**value** |  The array data to set.  
---|---  
**offset** |  The offset in this interleaved buffer's array. Default is `0`.  
  
**Returns:** A reference to this instance.

### .setUsage( value : [StaticDrawUsage](global.html#StaticDrawUsage) | [DynamicDrawUsage](global.html#DynamicDrawUsage) | [StreamDrawUsage](global.html#StreamDrawUsage) | [StaticReadUsage](global.html#StaticReadUsage) | [DynamicReadUsage](global.html#DynamicReadUsage) | [StreamReadUsage](global.html#StreamReadUsage) | [StaticCopyUsage](global.html#StaticCopyUsage) | [DynamicCopyUsage](global.html#DynamicCopyUsage) | [StreamCopyUsage](global.html#StreamCopyUsage) ) : [InterleavedBuffer](InterleavedBuffer.html)
