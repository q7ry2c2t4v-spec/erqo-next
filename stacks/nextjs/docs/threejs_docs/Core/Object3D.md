...
### .animations : Array.<[AnimationClip](AnimationClip.html)>
...
### .children : Array.<[Object3D](Object3D.html)>

An array holding the child 3D objects of this instance.

### .customDepthMaterial : [Material](Material.html) | undefined
...
### .customDistanceMaterial : [Material](Material.html) | undefined
...
### .matrixWorld : [Matrix4](Matrix4.html)
...
### .modelViewMatrix : [Matrix4](Matrix4.html)
...
### .normalMatrix : [Matrix3](Matrix3.html)

Represents the object's normal matrix.

### .parent : [Object3D](Object3D.html)

A reference to the parent object.

Default is `null`.

### .pivot : [Vector3](Vector3.html)
...
### .quaternion : [Quaternion](Quaternion.html)
...
### .rotation : [Euler](Euler.html)

Represents the object's local rotation as Euler angles, in radians.

Default is `(0,0,0)`.

### .scale : [Vector3](Vector3.html)
...
### .DEFAULT_UP : [Vector3](Vector3.html)
...
### .add( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)
...
### .applyMatrix4( matrix : [Matrix4](Matrix4.html) )
...
### .applyQuaternion( q : [Quaternion](Quaternion.html) ) : [Object3D](Object3D.html)
...
### .attach( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)
...
**object** |  The 3D object to attach.  
---|---  
...
### .clone( recursive : boolean ) : [Object3D](Object3D.html)

Returns a new 3D object with copied values from this instance.

**recursive** |  When set to `true`, descendants of the 3D object are also cloned. Default is `true`.  
---|---  
  
**Returns:** A clone of this instance.

### .copy( source : [Object3D](Object3D.html), recursive : boolean ) : [Object3D](Object3D.html)

Copies the values of the given 3D object to this instance.

**source** |  The 3D object to copy.  
---|---  
**recursive** |  When set to `true`, descendants of the 3D object are cloned. Default is `true`.  
  
**Returns:** A reference to this instance.

### .getObjectById( id : number ) : [Object3D](Object3D.html) | undefined
...
### .getObjectByName( name : string ) : [Object3D](Object3D.html) | undefined
...
### .getObjectByProperty( name : string, value : [any](global.html#any) ) : [Object3D](Object3D.html) | undefined
...
### .getObjectsByProperty( name : string, value : [any](global.html#any), result : Array.<[Object3D](Object3D.html)> ) : Array.<[Object3D](Object3D.html)>
...
---|---  
**value** |  The value.  
**result** |  The method stores the result in this array.  
...
### .getWorldPosition( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .getWorldQuaternion( target : [Quaternion](Quaternion.html) ) : [Quaternion](Quaternion.html)

Returns a Quaternion representing the position of the 3D object in world space.

**target** |  The target Quaternion the result is stored to.  
---|---  
  
**Returns:** The 3D object's rotation in world space.

### .getWorldScale( target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .localToWorld( vector : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .lookAt( x : number | [Vector3](Vector3.html), y : number, z : number )

Rotates the object to face a point in world space.

This method does not support objects having non-uniformly-scaled parent(s).

**x** |  The x coordinate in world space. Alternatively, a vector representing a position in world space  
---|---  
**y** |  The y coordinate in world space.  
**z** |  The z coordinate in world space.  
  
### .onAfterRender( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object )
...
**material** |  The 3D object's material.  
**group** |  The geometry group data.  
  
### .onAfterShadow( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), shadowCamera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), depthMaterial : [Material](Material.html), group : Object )
...
**object** |  The 3D object.  
**camera** |  The camera that is used to render the scene.  
**shadowCamera** |  The shadow camera.  
**geometry** |  The 3D object's geometry.  
**depthMaterial** |  The depth material.  
**group** |  The geometry group data.  
  
### .onBeforeRender( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html), group : Object )
...
### .onBeforeShadow( renderer : [Renderer](Renderer.html) | [WebGLRenderer](WebGLRenderer.html), object : [Object3D](Object3D.html), camera : [Camera](Camera.html), shadowCamera : [Camera](Camera.html), geometry : [BufferGeometry](BufferGeometry.html), depthMaterial : [Material](Material.html), group : Object )
...
### .raycast( raycaster : [Raycaster](Raycaster.html), intersects : Array.<Object> ) (abstract) 
...
---|---  
**intersects** |  An array holding the result of the method.  
  
### .remove( object : [Object3D](Object3D.html) ) : [Object3D](Object3D.html)

Removes the given 3D object as child from this 3D object. An arbitrary number of objects may be removed.

**object** |  The 3D object to remove.  
---|---  
...
### .removeFromParent() : [Object3D](Object3D.html)
...
### .rotateOnAxis( axis : [Vector3](Vector3.html), angle : number ) : [Object3D](Object3D.html)
...
### .rotateOnWorldAxis( axis : [Vector3](Vector3.html), angle : number ) : [Object3D](Object3D.html)
...
### .rotateX( angle : number ) : [Object3D](Object3D.html)
...
### .rotateY( angle : number ) : [Object3D](Object3D.html)
...
### .rotateZ( angle : number ) : [Object3D](Object3D.html)
...
### .setRotationFromAxisAngle( axis : [Vector3](Vector3.html), angle : number )
...
### .setRotationFromEuler( euler : [Euler](Euler.html) )
...
### .setRotationFromMatrix( m : [Matrix4](Matrix4.html) )

Sets the given rotation represented as rotation matrix to the 3D object.

**m** |  Although a 4x4 matrix is expected, the upper 3x3 portion must be a pure rotation matrix (i.e, unscaled).  
---|---  
  
### .setRotationFromQuaternion( q : [Quaternion](Quaternion.html) )
...
### .translateOnAxis( axis : [Vector3](Vector3.html), distance : number ) : [Object3D](Object3D.html)

Translate the 3D object by a distance along the given axis in local space.

**axis** |  The (normalized) axis vector.  
---|---  
**distance** |  The distance in world units.  
  
**Returns:** A reference to this instance.

### .translateX( distance : number ) : [Object3D](Object3D.html)
...
### .translateY( distance : number ) : [Object3D](Object3D.html)
...
### .translateZ( distance : number ) : [Object3D](Object3D.html)
...
**callback** |  A callback function that allows to process the current 3D object.  
---|---  
...
**force** |  When set to `true`, a recomputation of world matrices is forced even when [Object3D#matrixWorldNeedsUpdate](Object3D.html#matrixWorldNeedsUpdate) is `false`. Default is `false`.  
---|---  
...
**updateParents** |  Whether ancestor nodes should be updated or not. Default is `false`.  
---|---  
**updateChildren** |  Whether descendant nodes should be updated or not. Default is `false`.  
  
### .worldToLocal( vector : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
