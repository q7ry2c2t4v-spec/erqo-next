...
> Source: https://threejs.org/docs/pages/MeshBasicNodeMaterial.html
> Category: Core
...
### .setupLightMap( builder : [NodeBuilder](NodeBuilder.html) ) : [BasicLightMapNode](BasicLightMapNode.html).<vec3>
...
### .setupLightingModel() : [BasicLightingModel](BasicLightingModel.html)
