...
> Source: https://threejs.org/docs/pages/ObjectLoader.html
> Category: Core
...
### new ObjectLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .loadAsync( url : string, onProgress : [onProgressCallback](global.html#onProgressCallback) ) : Promise.<[Object3D](Object3D.html)> (async) 
...
### .parse( json : Object, onLoad : onLoad ) : [Object3D](Object3D.html)
...
**json** |  The serialized 3D object.  
---|---  
**onLoad** |  Executed when all resources (e.g. textures) have been fully loaded.  
  
**Overrides:** [Loader#parse](Loader.html#parse)

**Returns:** The parsed 3D object.

### .parseAsync( json : Object ) : Promise.<[Object3D](Object3D.html)> (async) 
