...
> Source: https://threejs.org/docs/pages/StorageTextureNode.html
> Category: Core
...
### new StorageTextureNode( value : [StorageTexture](StorageTexture.html), uvNode : [Node](Node.html).<(vec2|vec3)>, storeNode : [Node](Node.html) )
...
### .generateStore( builder : [NodeBuilder](NodeBuilder.html) )
...
### .setAccess( value : string ) : [StorageTextureNode](StorageTextureNode.html)
...
### .setMipLevel( level : number ) : [StorageTextureNode](StorageTextureNode.html)
...
### .toReadOnly() : [StorageTextureNode](StorageTextureNode.html)

Convenience method for configuring a read-only node access.

**Returns:** A reference to this node.

### .toReadWrite() : [StorageTextureNode](StorageTextureNode.html)

Convenience method for configuring a read/write node access.

**Returns:** A reference to this node.

### .toWriteOnly() : [StorageTextureNode](StorageTextureNode.html)
