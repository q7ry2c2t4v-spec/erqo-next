...
> Source: https://threejs.org/docs/pages/SphericalHarmonics3.html
> Category: Core
...
### .coefficients : Array.<[Vector3](Vector3.html)>
...
### .add( sh : [SphericalHarmonics3](SphericalHarmonics3.html) ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .addScaledSH( sh : [SphericalHarmonics3](SphericalHarmonics3.html), s : number ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .clone() : [SphericalHarmonics3](SphericalHarmonics3.html)

Returns a new spherical harmonics with copied values from this instance.

**Returns:** A clone of this instance.

### .copy( sh : [SphericalHarmonics3](SphericalHarmonics3.html) ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .equals( sh : [SphericalHarmonics3](SphericalHarmonics3.html) ) : boolean
...
### .fromArray( array : Array.<number>, offset : number ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .getAt( normal : [Vector3](Vector3.html), target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .getIrradianceAt( normal : [Vector3](Vector3.html), target : [Vector3](Vector3.html) ) : [Vector3](Vector3.html)
...
### .lerp( sh : [SphericalHarmonics3](SphericalHarmonics3.html), alpha : number ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .scale( s : number ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .set( coefficients : Array.<[Vector3](Vector3.html)> ) : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .zero() : [SphericalHarmonics3](SphericalHarmonics3.html)
...
### .getBasisAt( normal : [Vector3](Vector3.html), shBasis : Array.<number> )
