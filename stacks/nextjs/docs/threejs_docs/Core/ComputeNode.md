...
> Source: https://threejs.org/docs/pages/ComputeNode.html
> Category: Core
...
### new ComputeNode( computeNode : [Node](Node.html), workgroupSize : Array.<number> )
...
### .label( name : string ) : [ComputeNode](ComputeNode.html)
...
### .onInit( callback : function ) : [ComputeNode](ComputeNode.html)
...
### .setCount( count : number | Array.<number> ) : [ComputeNode](ComputeNode.html)

TODO

**count** |  Array with [ x, y, z ] values for dispatch or a single number for the count  
---|---  
  
### .setName( name : string ) : [ComputeNode](ComputeNode.html)
