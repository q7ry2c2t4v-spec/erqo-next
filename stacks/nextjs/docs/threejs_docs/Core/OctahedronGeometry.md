...
> Source: https://threejs.org/docs/pages/OctahedronGeometry.html
> Category: Core
...
---|---  
**detail** |  Setting this to a value greater than `0` adds vertices making it no longer a octahedron. Default is `0`.  
...
### .fromJSON( data : Object ) : [OctahedronGeometry](OctahedronGeometry.html)
