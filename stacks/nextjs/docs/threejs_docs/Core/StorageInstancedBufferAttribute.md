...
> Source: https://threejs.org/docs/pages/StorageInstancedBufferAttribute.html
> Category: Core

[BufferAttribute](BufferAttribute.html) → [InstancedBufferAttribute](InstancedBufferAttribute.html) → 
...
**count** |  The item count. It is also valid to pass a typed array as an argument. The subsequent parameters are then obsolete.  
---|---  
**itemSize** |  The item size.  
**typeClass** |  A typed array constructor. Default is `Float32Array`.  
