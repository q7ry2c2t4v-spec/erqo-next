...
> Source: https://threejs.org/docs/pages/WebXRManager.html
> Category: Core
...
### .getCameraTexture( xrCamera : XRCamera ) : [Texture](Texture.html)
...
### .getDepthSensingMesh() : [Mesh](Mesh.html)
...
### .getDepthTexture() : [Texture](Texture.html)
...
### .updateCamera( camera : [Camera](Camera.html) )
