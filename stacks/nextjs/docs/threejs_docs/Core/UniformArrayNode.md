...
> Source: https://threejs.org/docs/pages/UniformArrayNode.html
> Category: Core
...
### new UniformArrayNode( value : Array.<[any](global.html#any)>, elementType : string )
...
### .array : Array.<[any](global.html#any)>
...
### .element( indexNode : [IndexNode](IndexNode.html) ) : [UniformArrayElementNode](UniformArrayElementNode.html)
...
### .setup( builder : [NodeBuilder](NodeBuilder.html) ) : null
