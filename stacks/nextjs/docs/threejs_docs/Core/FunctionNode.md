...
> Source: https://threejs.org/docs/pages/FunctionNode.html
> Category: Core

[EventDispatcher](EventDispatcher.html) → [Node](Node.html) → [CodeNode](CodeNode.html) → 
...
### new FunctionNode( code : string, includes : Array.<[Node](Node.html)>, language : 'js' | 'wgsl' | 'glsl' )
...
### .getInputs( builder : [NodeBuilder](NodeBuilder.html) ) : Array.<[NodeFunctionInput](NodeFunctionInput.html)>
...
### .getNodeFunction( builder : [NodeBuilder](NodeBuilder.html) ) : [NodeFunction](NodeFunction.html)
