...
> Source: https://threejs.org/docs/pages/Matrix2.html
> Category: Core
...
### .fromArray( array : Array.<number>, offset : number ) : [Matrix2](Matrix2.html)
...
### .identity() : [Matrix2](Matrix2.html)

Sets this matrix to the 2x2 identity matrix.

**Returns:** A reference to this matrix.

### .set( n11 : number, n12 : number, n21 : number, n22 : number ) : [Matrix2](Matrix2.html)
