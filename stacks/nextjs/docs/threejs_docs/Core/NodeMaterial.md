...
> Source: https://threejs.org/docs/pages/NodeMaterial.html
> Category: Core
...
### .alphaTestNode : [Node](Node.html).<float>
...
### .castShadowNode : [Node](Node.html).<vec4>
...
### .castShadowPositionNode : [Node](Node.html).<float>
...
### .fragmentNode : [Node](Node.html).<vec4>
...
### .opacityNode : [Node](Node.html).<float>
...
### .outputNode : [Node](Node.html).<vec4>
...
### .receivedShadowNode : function | [FunctionNode](FunctionNode.html).<vec4>
...
### .receivedShadowPositionNode : [Node](Node.html).<float>
...
### .vertexNode : [Node](Node.html).<vec4>
...
### .build( builder : [NodeBuilder](NodeBuilder.html) )
...
### .copy( source : [NodeMaterial](NodeMaterial.html) ) : [NodeMaterial](NodeMaterial.html)
...
### .setDefaultValues( material : [Material](Material.html) )
...
### .setupClipping( builder : [NodeBuilder](NodeBuilder.html) ) : [ClippingNode](ClippingNode.html)
...
### .setupDepth( builder : [NodeBuilder](NodeBuilder.html) )
...
### .setupDiffuseColor( builder : [NodeBuilder](NodeBuilder.html), geometry : [BufferGeometry](BufferGeometry.html) )
...
### .setupEnvironment( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec4>
...
### .setupFog( builder : [NodeBuilder](NodeBuilder.html), outputNode : [Node](Node.html).<vec4> ) : [Node](Node.html).<vec4>
...
### .setupHardwareClipping( builder : [NodeBuilder](NodeBuilder.html) )
...
### .setupLightMap( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec3>
...
### .setupLighting( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec3>
...
### .setupLightingModel( builder : [NodeBuilder](NodeBuilder.html) ) : [LightingModel](LightingModel.html) (abstract) 
...
### .setupLights( builder : [NodeBuilder](NodeBuilder.html) ) : [LightsNode](LightsNode.html)
...
### .setupModelViewProjection( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec4>
...
### .setupNormal() : [Node](Node.html).<vec3>

Setups the normal node from the material.

**Returns:** The normal node.

### .setupObserver( builder : [NodeBuilder](NodeBuilder.html) ) : [NodeMaterialObserver](NodeMaterialObserver.html)
...
### .setupOutgoingLight() : [Node](Node.html).<vec3>

Setups the outgoing light node variable

**Returns:** The outgoing light node.

### .setupOutput( builder : [NodeBuilder](NodeBuilder.html), outputNode : [Node](Node.html).<vec4> ) : [Node](Node.html).<vec4>
...
### .setupPosition( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec3>
...
### .setupPositionView( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec3>
...
### .setupPremultipliedAlpha( builder : [NodeBuilder](NodeBuilder.html), outputNode : [Node](Node.html).<vec4> ) : [Node](Node.html).<vec4>
...
### .setupVariants( builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .setupVertex( builder : [NodeBuilder](NodeBuilder.html) ) : [Node](Node.html).<vec4>
