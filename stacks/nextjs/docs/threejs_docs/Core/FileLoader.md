...
> Source: https://threejs.org/docs/pages/FileLoader.html
> Category: Core
...
### new FileLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .abort() : [FileLoader](FileLoader.html)
...
### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : [any](global.html#any) | undefined
...
### .setMimeType( value : string ) : [FileLoader](FileLoader.html)
...
### .setResponseType( value : 'arraybuffer' | 'blob' | 'document' | 'json' | '' ) : [FileLoader](FileLoader.html)
