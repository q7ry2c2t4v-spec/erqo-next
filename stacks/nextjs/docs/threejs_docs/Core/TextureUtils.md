...
> Source: https://threejs.org/docs/pages/TextureUtils.html
> Category: Core
...
### .contain( texture : [Texture](Texture.html), aspect : number ) : [Texture](Texture.html)
...
### .cover( texture : [Texture](Texture.html), aspect : number ) : [Texture](Texture.html)
...
### .fill( texture : [Texture](Texture.html) ) : [Texture](Texture.html)
