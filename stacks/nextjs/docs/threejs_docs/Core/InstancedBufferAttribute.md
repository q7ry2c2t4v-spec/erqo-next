...
> Source: https://threejs.org/docs/pages/InstancedBufferAttribute.html
> Category: Core
...
**meshPerAttribute** |  How often a value of this buffer attribute should be repeated. Default is `1`.  
