...
> Source: https://threejs.org/docs/pages/Line2NodeMaterial.html
> Category: Core
...
### .dashScaleNode : [Node](Node.html).<float>

Defines the dash scale.

Default is `null`.

### .dashSizeNode : [Node](Node.html).<float>
...
### .gapSizeNode : [Node](Node.html).<float>
...
### .lineColorNode : [Node](Node.html).<vec3>
