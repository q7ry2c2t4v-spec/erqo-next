...
> Source: https://threejs.org/docs/pages/IndirectStorageBufferAttribute.html
> Category: Core

[BufferAttribute](BufferAttribute.html) → [StorageBufferAttribute](StorageBufferAttribute.html) → 
