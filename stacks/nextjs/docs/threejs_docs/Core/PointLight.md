...
> Source: https://threejs.org/docs/pages/PointLight.html
> Category: Core
...
### new PointLight( color : number | [Color](Color.html) | string, intensity : number, distance : number, decay : number )
...
### .shadow : [PointLightShadow](PointLightShadow.html)
