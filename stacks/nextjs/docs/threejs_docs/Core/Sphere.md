...
> Source: https://threejs.org/docs/pages/Sphere.html
> Category: Core
...
### new Sphere( center : [Vector3](Vector3.html), radius : number )

Constructs a new sphere.

**center** |  The center of the sphere Default is `(0,0,0)`.  
---|---  
...
### .applyMatrix4( matrix : [Matrix4](Matrix4.html) ) : [Sphere](Sphere.html)
...
### .copy( sphere : [Sphere](Sphere.html) ) : [Sphere](Sphere.html)
...
### .equals( sphere : [Sphere](Sphere.html) ) : boolean

Returns `true` if this sphere is equal with the given one.

**sphere** |  The sphere to test for equality.  
---|---  
  
**Returns:** Whether this bounding sphere is equal with the given one.

### .expandByPoint( point : [Vector3](Vector3.html) ) : [Sphere](Sphere.html)
...
### .fromJSON( json : Object ) : [Sphere](Sphere.html)

Returns a serialized structure of the bounding sphere.

**json** |  The serialized json to set the sphere from.  
---|---  
  
**Returns:** A reference to this bounding sphere.

### .getBoundingBox( target : [Box3](Box3.html) ) : [Box3](Box3.html)

Returns a bounding box that encloses this sphere.

**target** |  The target box that is used to store the method's result.  
---|---  
...
### .makeEmpty() : [Sphere](Sphere.html)

Makes this sphere empty which means in encloses a zero space in 3D.

**Returns:** A reference to this sphere.

### .set( center : [Vector3](Vector3.html), radius : number ) : [Sphere](Sphere.html)
...
### .setFromPoints( points : Array.<[Vector3](Vector3.html)>, optionalCenter : [Vector3](Vector3.html) ) : [Sphere](Sphere.html)
...
### .translate( offset : [Vector3](Vector3.html) ) : [Sphere](Sphere.html)
...
### .union( sphere : [Sphere](Sphere.html) ) : [Sphere](Sphere.html)

Expands this sphere to enclose both the original sphere and the given sphere.

**sphere** |  The sphere to include.  
---|---  
