...
> Source: https://threejs.org/docs/pages/QuadraticBezierCurve.html
> Category: Core
...
### new QuadraticBezierCurve( v0 : [Vector2](Vector2.html), v1 : [Vector2](Vector2.html), v2 : [Vector2](Vector2.html) )
