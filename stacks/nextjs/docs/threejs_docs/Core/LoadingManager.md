...
> Source: https://threejs.org/docs/pages/LoadingManager.html
> Category: Core
...
### .abort() : [LoadingManager](LoadingManager.html)
...
### .addHandler( regex : string, loader : [Loader](Loader.html) ) : [LoadingManager](LoadingManager.html)
...
### .getHandler( file : string ) : [Loader](Loader.html)
...
### .removeHandler( regex : string ) : [LoadingManager](LoadingManager.html)
...
### .setURLModifier( transform : function ) : [LoadingManager](LoadingManager.html)
