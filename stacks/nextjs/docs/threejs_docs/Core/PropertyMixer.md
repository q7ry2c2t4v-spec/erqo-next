...
> Source: https://threejs.org/docs/pages/PropertyMixer.html
> Category: Core
...
### new PropertyMixer( binding : [PropertyBinding](PropertyBinding.html), typeName : string, valueSize : number )

Constructs a new property mixer.

**binding** |  The property binding.  
---|---  
**typeName** |  The keyframe track type name.  
**valueSize** |  The keyframe track value size.  
  
## Properties

### .binding : [PropertyBinding](PropertyBinding.html)
...
**accuIndex** |  The accumulation index.  
---|---  
**weight** |  The weight.  
