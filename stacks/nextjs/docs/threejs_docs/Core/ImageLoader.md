...
> Source: https://threejs.org/docs/pages/ImageLoader.html
> Category: Core
...
### new ImageLoader( manager : [LoadingManager](LoadingManager.html) )
...
### .load( url : string, onLoad : function, onProgress : [onProgressCallback](global.html#onProgressCallback), onError : [onErrorCallback](global.html#onErrorCallback) ) : Image
