...
> Source: https://threejs.org/docs/pages/ViewportTextureNode.html
> Category: Core
...
### new ViewportTextureNode( uvNode : [Node](Node.html), levelNode : [Node](Node.html), framebufferTexture : [Texture](Texture.html) )
...
### .defaultFramebuffer : [FramebufferTexture](FramebufferTexture.html)
...
### .getTextureForReference( reference : [RenderTarget](RenderTarget.html) ) : [Texture](Texture.html)
