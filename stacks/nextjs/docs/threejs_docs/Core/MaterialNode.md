...
> Source: https://threejs.org/docs/pages/MaterialNode.html
> Category: Core
...
### .getCache( property : string, type : string ) : [MaterialReferenceNode](MaterialReferenceNode.html)
...
### .getColor( property : string ) : [MaterialReferenceNode](MaterialReferenceNode.html).<color>
...
### .getFloat( property : string ) : [MaterialReferenceNode](MaterialReferenceNode.html).<float>
...
### .getTexture( property : string ) : [MaterialReferenceNode](MaterialReferenceNode.html)
