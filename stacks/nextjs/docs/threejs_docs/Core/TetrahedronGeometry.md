...
> Source: https://threejs.org/docs/pages/TetrahedronGeometry.html
> Category: Core
...
---|---  
**detail** |  Setting this to a value greater than `0` adds vertices making it no longer a tetrahedron. Default is `0`.  
...
### .fromJSON( data : Object ) : [TetrahedronGeometry](TetrahedronGeometry.html)
