...
> Source: https://threejs.org/docs/pages/LightingModel.html
> Category: Core
...
### .ambientOcclusion( builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .direct( lightData : Object, builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .directRectArea( lightData : Object, builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .finish( builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .indirect( builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
...
### .start( builder : [NodeBuilder](NodeBuilder.html) ) (abstract) 
