...
> Source: https://threejs.org/docs/pages/CurvePath.html
> Category: Core
...
### .curves : Array.<[Curve](Curve.html)>

An array of curves defining the path.

## Methods

### .add( curve : [Curve](Curve.html) )
...
### .closePath() : [CurvePath](CurvePath.html)
...
### .getPoint( t : number, optionalTarget : [Vector2](Vector2.html) | [Vector3](Vector3.html) ) : [Vector2](Vector2.html) | [Vector3](Vector3.html)
