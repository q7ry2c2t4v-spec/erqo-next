...
> Source: https://threejs.org/docs/pages/Line.html
> Category: Core
...
### new Line( geometry : [BufferGeometry](BufferGeometry.html), material : [Material](Material.html) | Array.<[Material](Material.html)> )
...
### .computeLineDistances() : [Line](Line.html)
