...
> Source: https://threejs.org/docs/pages/ReferenceBaseNode.html
> Category: Core
...
### .setGroup( group : [UniformGroupNode](UniformGroupNode.html) ) : [ReferenceBaseNode](ReferenceBaseNode.html)
...
### .setup() : [UniformNode](UniformNode.html)
