...
> Source: https://threejs.org/docs/pages/WorkgroupInfoNode.html
> Category: Core
...
**scope** |  TODO.  
---|---  
**bufferType** |  The data type of a 'workgroup' scoped buffer element.  
**bufferCount** |  The number of elements in the buffer. Default is `0`.  
...
### .element( indexNode : [IndexNode](IndexNode.html) ) : [WorkgroupInfoElementNode](WorkgroupInfoElementNode.html)
...
### .label( name : string ) : [WorkgroupInfoNode](WorkgroupInfoNode.html)
...
### .setName( name : string ) : [WorkgroupInfoNode](WorkgroupInfoNode.html)
...
### .setScope( scope : string ) : [WorkgroupInfoNode](WorkgroupInfoNode.html)
