...
> Source: https://threejs.org/docs/pages/ReferenceElementNode.html
> Category: Core
...
### new ReferenceElementNode( referenceNode : [ReferenceBaseNode](ReferenceBaseNode.html), indexNode : [Node](Node.html) )
...
### .referenceNode : [ReferenceBaseNode](ReferenceBaseNode.html)
...
### .referenceNode : [ReferenceNode](ReferenceNode.html)
...
### new ReferenceElementNode( referenceNode : [ReferenceNode](ReferenceNode.html), indexNode : [Node](Node.html) )
