...
> Source: https://threejs.org/docs/pages/Box2.html
> Category: Core
...
### new Box2( min : [Vector2](Vector2.html), max : [Vector2](Vector2.html) )

Constructs a new bounding box.

**min** |  A vector representing the lower boundary of the box. Default is `(Infinity,Infinity)`.  
---|---  
**max** |  A vector representing the upper boundary of the box. Default is `(-Infinity,-Infinity)`.  
...
### .max : [Vector2](Vector2.html)

The upper boundary of the box.

### .min : [Vector2](Vector2.html)

The lower boundary of the box.

## Methods

### .clampPoint( point : [Vector2](Vector2.html), target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .clone() : [Box2](Box2.html)

Returns a new box with copied values from this instance.

**Returns:** A clone of this instance.

### .containsBox( box : [Box2](Box2.html) ) : boolean
...
### .containsPoint( point : [Vector2](Vector2.html) ) : boolean
...
### .copy( box : [Box2](Box2.html) ) : [Box2](Box2.html)
...
### .distanceToPoint( point : [Vector2](Vector2.html) ) : number
...
### .equals( box : [Box2](Box2.html) ) : boolean
...
### .expandByPoint( point : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .expandByScalar( scalar : number ) : [Box2](Box2.html)
...
### .expandByVector( vector : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .getCenter( target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .getParameter( point : [Vector2](Vector2.html), target : [Vector2](Vector2.html) ) : [Vector2](Vector2.html)
...
### .intersect( box : [Box2](Box2.html) ) : [Box2](Box2.html)
...
### .intersectsBox( box : [Box2](Box2.html) ) : boolean
...
### .makeEmpty() : [Box2](Box2.html)

Makes this box empty which means in encloses a zero space in 2D.

**Returns:** A reference to this bounding box.

### .set( min : [Vector2](Vector2.html), max : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .setFromCenterAndSize( center : [Vector2](Vector2.html), size : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .setFromPoints( points : Array.<[Vector2](Vector2.html)> ) : [Box2](Box2.html)

Sets the upper and lower bounds of this box so it encloses the position data in the given array.

**points** |  An array holding 2D position data as instances of [Vector2](Vector2.html).  
---|---  
  
**Returns:** A reference to this bounding box.

### .translate( offset : [Vector2](Vector2.html) ) : [Box2](Box2.html)
...
### .union( box : [Box2](Box2.html) ) : [Box2](Box2.html)
